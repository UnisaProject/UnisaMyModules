...
public class HeadingTag extends BodyTagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        try {
           // out.write("<h3>\n"); //Sifiso Changes: 2018/08/28: Change the margins of the h3 heading to remove extra spacing from struts tools
            out.write("<h3 style=\"margin-top:0; margin-bottom:5px\">\n");
        } catch (IOException e) {
