...
public class FlatListTag extends BodyTagSupport {
    ...
    /** Our log (commons). */
    private static Log M_log = LogFactory.getLog(FlatListTag.class);
    
    public int doStartTag() throws JspException {
        JspWriter out = this.pageContext.getOut();

        try {
            out.write("<table class=\"listHier\" cellspacing=\"0\">\n");
        } catch (IOException e) {
