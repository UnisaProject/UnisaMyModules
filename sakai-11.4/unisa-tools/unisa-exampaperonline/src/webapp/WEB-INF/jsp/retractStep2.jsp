...
<sakai:html>	
	<html:form action="/retractDocument">	
		<html:hidden property="currentPage" value="retractStep2"/>
		<html:hidden property="xpoAction" value=""/>
		<sakai:messages/>
		<sakai:messages message="true"/>			
		<sakai:heading>
			<fmt:message key="retractStep2.heading"/>
		</sakai:heading>
		<sakai:group_table>	
			<tr>
		...
		<hr/>
		<sakai:group_heading>
			<fmt:message key="retractStep2.groupheading2"/> 
		</sakai:group_heading>	
		<sakai:group_table>
			<tr>			
		...
		<sakai:group_heading>
			<fmt:message key="retractStep2.groupheading1"/> 
		</sakai:group_heading>	
		<sakai:instruction>
			<fmt:message key="retractStep2.note1"/>
		</sakai:instruction>
		<sakai:group_table>
			<logic:empty name="examPaperOnlineForm" property="selectedPaper.documentList">
				<tr><td colspan="2">
					<fmt:message key="retractStep2.note2"/> 
				</td></tr>
			</logic:empty>
			<logic:notEmpty name="examPaperOnlineForm" property="selectedPaper.documentList">
				<logic:iterate name="examPaperOnlineForm" property="selectedPaper.documentList" id="record">
					...
					<tr> 				
						...
						<td><html:link href="retractDocument.do?action=open" scope="page" name="params">                                   							
