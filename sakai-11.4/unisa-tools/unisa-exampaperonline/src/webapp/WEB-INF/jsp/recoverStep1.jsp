...
<sakai:html>	
	<html:form action="/recoverDocument">	
		<html:hidden property="currentPage" value="recoverStep1"/>
		<html:hidden property="xpoAction" value=""/>
		<html:hidden property="displayListAction" value="D"/>
		<sakai:messages/>
		<sakai:messages message="true"/>	
		<sakai:heading>
			<fmt:message key="recoverStep1.heading"/>
		</sakai:heading>		
		<sakai:group_table>	
			<tr>
		...
		<sakai:flat_list>
			...
			<td colspan="2">				
				<sakai:heading>
						<fmt:message key="recoverStep1.groupheading1"/> 
				</sakai:heading>	
				<sakai:instruction>
						<fmt:message key="recoverStep1.note1"/>
				</sakai:instruction>
			</td>				
			...
			<tr>
				<th align="left"><fmt:message key="tabHead.recover.examination"/></th>
				<th align="left"><fmt:message key="tabHead.recover.linkedPapers"/></th>
				<th align="left"><fmt:message key="tabHead.recover.from"/></th>
				<th align="left"><fmt:message key="tabHead.recover.response"/></th>
				<th align="left"><fmt:message key="tabHead.recover.dateSent"/></th>				
			</tr>
				...
				<logic:iterate name="examPaperOnlineForm" property="availableDocList" id="record">
					...
					<tr> 						
						<td style="white-space: nowrap">
							...
							<html:link href="recoverDocument.do?action=recover" scope="page" name="params">                                   							
									<fmt:message key="link.recover"/>
							</html:link>
						</td>
						<td style="white-space: nowrap">
