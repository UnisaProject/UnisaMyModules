	...
	<html:form action="/resetDocument">	
		...
		<sakai:flat_list>
			<tr>
				<td colspan="3">
					<sakai:heading>
						<fmt:message key="resetStep1.groupheading1"/> 
					</sakai:heading>			
					<sakai:instruction>
						<fmt:message key="resetStep1.note1"/>
					</sakai:instruction>
				</td>				
			...
			<tr>
				<th align="left"><fmt:message key="tabHead.reset.examination"/></th>
				<th align="left"><fmt:message key="tabHead.reset.linkedPapers"/></th>
				<th align="left"><fmt:message key="tabHead.reset.myRole"/></th>
				<th align="left"><fmt:message key="tabHead.reset.from"/></th>
				<th align="left"><fmt:message key="tabHead.reset.response"/></th>
				<th align="left"><fmt:message key="tabHead.reset.dateSent"/></th>				
			</tr>
			<logic:notEmpty name="examPaperOnlineForm" property="availableDocList">
				<logic:iterate name="examPaperOnlineForm" property="availableDocList" id="record">
					...
					%>
					<% 
						java.util.HashMap resetParams = new java.util.HashMap();
						resetParams.put("studyUnit",studyUnit);
						resetParams.put("examYear",examYear);
						resetParams.put("examPeriod",examPeriod);
						resetParams.put("paperNo",paperNo);
						resetParams.put("docType",docType);
						pageContext.setAttribute("resetParams",resetParams);
					%>					
					<tr> 						
						<td style="white-space: nowrap">
							...
							<html:link href="resetDocument.do?action=show" scope="page" name="params">                                   							
									<fmt:message key="link.show"/>
							</html:link>&nbsp;&nbsp;
							<html:link href="resetDocument.do?action=displayReset" scope="page" name="resetParams">                                   							
									<fmt:message key="link.reset"/>
							</html:link>		
						</td>	
						<td style="white-space: nowrap">
