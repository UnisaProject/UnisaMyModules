...
<sakai:html>
	...
	<html:hidden property="currentPage" value="reviewResult"/>
		<sakai:messages/>
		<sakai:messages message="true"/>
		<sakai:heading>
			<fmt:message key="heading.reviewResult"/>
		</sakai:heading>
		<sakai:flat_list>
			<tr>
		...
		<sakai:flat_list>
			<bean:define id="currentPage" value="reviewResult"/>
			<tr>
			...
			<tr>
				<sakai:group_table>
					...
					<td>
						<bean:write name="mdRpmForm" property="tracking.proposedResult.engDescription"/>
					</td>
					<!--<logic:iterate name="mdRpmForm" property="resultTypeList" id="record" indexId="index">
						<tr>
							<td><html:radio property="tracking.proposedResult" idName="record" value="code" disabled="true"></html:radio></td>								
		...
		<sakai:flat_list>
			<tr>
				<th><fmt:message key="heading.general.rpm.yourResponse"/></th>
			</tr>
			<sakai:group_table>
				<tr>
					<th colspan="2"><fmt:message key="heading.table.response"/></th>
				</tr>
				<logic:iterate name="mdRpmForm" property="responseList" id="record" indexId="index">
					<tr>
						<td><html:radio property="selectedResponse" idName="record" value="value"></html:radio></td>								
