...
<sakai:html>
	...
	<html:hidden property="currentPage" value="proposeResult"/>
		<sakai:messages/>
		<sakai:messages message="true"/>
		<sakai:heading>
			<fmt:message key="heading.proposeResult"/>
		</sakai:heading>
		<sakai:flat_list>
			<tr>
		...
		<sakai:flat_list>
			<bean:define id="currentPage" value="proposeResult"/>	
			<tr>
		...
		<sakai:flat_list>
			<tr>
				<th><fmt:message key="heading.general.rpm.proposedResult"/></th>
			</tr>
			<tr>
				<sakai:group_table>
					<tr>
