...
<sakai:html>
	<html:form action="/tutorStudentGrouping">
		<html:hidden property="currentPage" value="inputReassignStudent"/>
		<sakai:messages/>
		...
		<sakai:instruction>
			<b><fmt:message key="instr.inputReassignStudent.completeDetails"/></b>
		</sakai:instruction>			
		<sakai:instruction>
		...
		<sakai:group_table>				
			<tr>
				<td><b><fmt:message key="prompt.enterStudentNumber"/></b>&nbsp;<fmt:message key="note.mandatory"/><br/></td>
				<td><html:text name="tutorStudentGroupForm" property="studentNr" size="10" maxlength="8"></html:text></td>
		
			</tr>			
		</sakai:group_table>	
		<sakai:actions>
			<html:submit property="act">
					<fmt:message key="button.tutorGroupInfo"/>
			</html:submit>
			<html:submit property="act">
