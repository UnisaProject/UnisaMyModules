...
<sakai:html>		
	<html:form action="/authorisation">
		<sakai:heading><fmt:message key="heading.altExamOptView"/></sakai:heading>
		<!--<html:hidden name="finalMarkConcessionForm" property="currentPage" value="form"/>-->
		<sakai:messages/>
		...
		<sakai:group_table>
			...
			<!-- <tr>
				 <td>&nbsp;</td>
				 <logic:equal name="finalMarkConcessionForm" property="recordSelected.status" value="DECLINED">
				 	<td colspan=2>
				 		<logic:notEqual name="finalMarkConcessionForm" property="alternativeExamOpportunity.adminDeclineOpt" value="OT">
				 			<bean:write name="finalMarkConcessionForm" property="alternativeExamOpportunity.adminDeclineOptDesc"/>
				 		</logic:notEqual>
				 ...
				 <logic:notEqual name="finalMarkConcessionForm" property="recordSelected.status" value="DECLINED">
				 	<td>&nbsp;</td>
				 	<td>&nbsp;</td> 	
				 </logic:notEqual>
			</tr> -->
		...
		<logic:equal name="finalMarkConcessionForm" property="recordSelected.status" value="IDENTIFIED">
			<sakai:group_table>
				<tr>
					<td><fmt:message key="note.awaitingLecturer"/></td>					
				</tr>
			</sakai:group_table>					
		</logic:equal>
		<logic:notEqual name="finalMarkConcessionForm" property="recordSelected.status" value="IDENTIFIED">
			<sakai:group_table>
				<tr>
					<td><fmt:message key="prompt.alternativeAssess"/></td>
					<td><bean:write name="finalMarkConcessionForm" property="alternativeExamOpportunity.alternativeAssessOpt"/>&nbsp;-&nbsp;<bean:write name="finalMarkConcessionForm" property="alternativeExamOpportunity.alternativeAssessOptDesc"/></td>
				</tr>
				...
				<tr>
				   ...
				   <td>
				   		<bean:write name="finalMarkConcessionForm" property="alternativeExamOpportunity.concessionMark"/>
