...
public class LocationType implements java.io.Serializable {
    ...
    public static final java.lang.String _Worklist = "Worklist";
    public static final LocationType Catalog = new LocationType(_Catalog);
    public static final LocationType Worklist = new LocationType(_Worklist);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/UniflowFindAndGetService", "LocationType"));
    }
    /**
