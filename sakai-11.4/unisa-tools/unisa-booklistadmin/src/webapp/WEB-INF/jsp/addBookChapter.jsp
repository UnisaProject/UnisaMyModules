...
<sakai:html>
	...
	<html:form action="booklistadmin">
		...
		<sakai:group_table>
				...
				<td><fmt:message key="label.tableheaderchaptertitle"/></td>				
				<td><html:text property="txtTitle" size="60" maxlength="256"></html:text></td>
			</tr>
			
			<tr>
				<td><fmt:message key="label.tableheaderchapterauthor"/> </td>
				<td><html:text property="txtAuthor" size="60" maxlength="256"></html:text></td>
			</tr>
			<tr>			<td><fmt:message key="label.tableheaderchapterauthoreditor"/></td>
				<td><html:text property="txtOtherAuthor" size="60" maxlength="256"></html:text> <fmt:message key="label.tableheaderchapterauthoreditorrule"/></td>
			</tr>
			<tr>			
			<td><fmt:message key="label.tableheaderebookpublication"/> <sakai:required/> </td>
			<td><html:text property="txtPublisher" size="40" maxlength="256"></html:text> <fmt:message key="label.tableheaderebookpublicationrule"/></td>
			</tr>
			<tr>			
			<td><fmt:message key="label.tableheaderebookchapteredition"/></td>
			<td><html:text property="ebookVolume" size="8" maxlength="10"></html:text> <fmt:message key="label.tableheaderebookchaptereditionrule"/> </td>
			</tr>
			<tr>
