...
<logic:equal name ="booklistAdminForm" property="releaseDateRemovalScrnEntered" value="true">
<sakai:instruction>
	<fmt:message key="function.confirmremovalheading" />
</sakai:instruction>
<br>
...
<html:form action="booklistadmin">
	<sakai:group_table>
		<tr>
			<sakai:flat_list>
				...
				<logic:notEmpty name="booklistAdminForm" property="booklist">
					<logic:equal name="booklistAdminForm" property="releaseDateRemoved" value="false">
						<logic:iterate name="booklistAdminForm" property="booklist" id="c" indexId="cindex">
							<logic:equal name="c" property="remove" value="true">
								<tr>
									<td><bean:write name="c" property="academicYear" /></td>
									<td><bean:write name="c" property="releaseDate" /></td>
								</tr>
							</logic:equal>
						</logic:iterate>
					</logic:equal>
	...
	<sakai:group_table>
		<tr>
			<td><sakai:actions>
				<html:submit styleClass="button" property="action">
					<fmt:message key="button.releasedatesremoval" />
				</html:submit>
				<html:submit styleClass="button" property="action">
					<fmt:message key="button.backtoreleasedatesmanagement" />
				</html:submit>
				<html:submit styleClass="button" property="action">
					<fmt:message key="button.cancelReleaseDatesSelection" />
				</html:submit>
			</sakai:actions></td>
		</tr>
	</sakai:group_table>
