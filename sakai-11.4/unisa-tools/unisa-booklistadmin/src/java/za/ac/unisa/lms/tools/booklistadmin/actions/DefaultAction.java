...
public class DefaultAction extends DispatchAction {
	...
	public ActionForward execute(
		...
		HttpServletResponse response
		     ...
		     userDirService = (UserDirectoryService)ComponentManager.get(UserDirectoryService.class);
		     Session currentSession = sessionManager.getCurrentSession();	
		     String userID = currentSession.getUserId();		
		     log.error("TYPE: getparameter(UserId) "+request.getParameter("UserID"));		
		     log.error("TYPE: getparameter(type) "+request.getParameter("TYPE"));		     
