...
<sakai:html>	
	<html:form action="/tutoringPlanDetails">
		<html:hidden property="currentPage" value="displayDetailList"/>
		<sakai:messages/>
		...
		<sakai:flat_list>
		<tr>
					<th><fmt:message key="column.detail.school"/></th>					
					<th><fmt:message key="column.detail.dept"/></th>
					<th><fmt:message key="column.detail.studyUnit"/></th>
					<th><fmt:message key="column.detail.tutorMode"/></th>
					<th><fmt:message key="column.tutorMode.groupingMethod"/></th>
					<th><fmt:message key="column.detail.tutorStudentRatio"/></th>
					<th><fmt:message key="column.detail.maxGroups"/></th>
					<th><fmt:message key="column.detail.includeLect"/></th>
				</tr>
				<logic:iterate name="tutorPlanList" id="record" indexId="index">
					<tr>
						<td><bean:write name="record" property="schoolAbbrev"/></td>
						...
						<td><bean:write name="record" property="tutoringMode.groupChoice"/></td>
						<td><bean:write name="record" property="tutoringMode.tutorStuRatio"/></td>
						<td><bean:write name="record" property="tutoringMode.maxGroupsPerTutor"/></td>
						<td><bean:write name="record" property="tutoringMode.includeLectAsTutors"/></td>
					</tr>
				</logic:iterate>		
		</sakai:flat_list>	
	</html:form>
