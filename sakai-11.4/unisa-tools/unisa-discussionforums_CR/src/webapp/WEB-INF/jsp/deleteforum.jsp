...
<sakai:html>
	<sakai:heading><fmt:message key="forum.delete"/></sakai:heading>
	<sakai:messages/>
	<html:form action="forums">
		<sakai:group_table>
			<tr>
				<td><b><bean:write name="forumDetailsForm" property="forum.forumName"/></b></td>
			</tr>
			<tr>
				<td><bean:write name="forumDetailsForm" property="forum.forumDescription"/></td>
			</tr>
		</sakai:group_table>
   		<sakai:actions>
