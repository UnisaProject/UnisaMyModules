...
<sakai:html>
	...
	<input type="hidden" name="hidden" value="1"/>
		<sakai:group_table>
			<tr>
				<td><b><bean:write name="forumTopicsForm" property="topicForumName"/> <fmt:message key="forum.arrow"/> <bean:write name="forumMessageForm" property="messageTopic"/> </b> <bean:write name="forumMessageForm" property="forumMessage.author"/> <bean:write name="forumMessageForm" property="forumMessage.messageDate"/></td>
			</tr>
			<tr>
