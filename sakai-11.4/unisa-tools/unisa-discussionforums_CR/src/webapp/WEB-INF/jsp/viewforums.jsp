...
<sakai:html>
	...
	<logic:notEmpty name="forumDetailsForm" property="siteForums">
		<sakai:instruction>
			<fmt:message key="forum.index.information0.new"></fmt:message>
			<fmt:message key="forum.index.information1.new"></fmt:message><br><br>
			<fmt:message key="forum.index.information3.new"></fmt:message>
