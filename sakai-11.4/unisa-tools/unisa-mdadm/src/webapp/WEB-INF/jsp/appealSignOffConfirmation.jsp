...
<sakai:html>
	...
	<html:hidden property="currentPage" value="appealSignOffConfirmation"/>

		<sakai:heading><fmt:message key="page.heading.signoff.appeal.confirmation"/></sakai:heading>
		<sakai:messages/>
	<sakai:flat_list>
			<tr>
	...
	<sakai:flat_list>			
			<tr>				
				<logic:equal name="mdAdmissionForm" property="newTrackRecord.currentLevel" value="E">
					<logic:equal name="mdAdmissionForm" property="newTrackRecord.recommendation.code" value="LN">
						<th><fmt:message key="section.heading.appeal.confirmation.levelE.referBackAdmin"/></th>
					</logic:equal>
					<logic:equal name="mdAdmissionForm" property="newTrackRecord.recommendation.code" value="LT">
						<th><fmt:message key="section.heading.appeal.confirmation.levelE.admissionNotApproved"/></th>
					</logic:equal>
					<logic:notEqual name="mdAdmissionForm" property="newTrackRecord.recommendation.code" value="LN">
						<logic:notEqual name="mdAdmissionForm" property="newTrackRecord.recommendation.code" value="LT">
							<th><fmt:message key="section.heading.appeal.confirmation.levelE.admissionApproved"/></th>
						</logic:notEqual>	
					</logic:notEqual>
				</logic:equal>
				<logic:equal name="mdAdmissionForm" property="newTrackRecord.currentLevel" value="I">
					<th><fmt:message key="section.heading.appeal.confirmation.levelI"/></th>								
				</logic:equal>	
			</tr>	
			<tr>
				<sakai:group_table>
			...
			<logic:notEmpty  name="mdAdmissionForm" property="signoffStaffList">	
				<tr><td>
					<sakai:group_table>
								<tr>
									<td colspan="3"><fmt:message key="instruction.appeal.confirmation.selectPerson"/></td>
								</tr>	
								<tr>
