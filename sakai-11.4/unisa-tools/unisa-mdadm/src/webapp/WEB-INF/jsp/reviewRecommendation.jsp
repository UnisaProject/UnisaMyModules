...
<sakai:html>
	...
	<html:hidden property="currentPage" value="reviewRecommendation"/>

		<sakai:heading><fmt:message key="page.heading.reviewRecommendation"/></sakai:heading>
		<sakai:messages/>
	<sakai:flat_list>
			<tr>
	...
	<sakai:flat_list>
			<tr>
				<th><fmt:message key="section.heading.yourResponse"/></th>
			</tr>
			<tr>
				<sakai:group_table>
					<tr>
						<th colspan="2"><fmt:message key="instruction.reviewRecommendation"/></th>
					</tr>
						<logic:iterate name="mdAdmissionForm" property="responseList" id="record" indexId="index">
					<tr>
