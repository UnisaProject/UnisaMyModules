...
<sakai:html>
	...
	<html:hidden property="currentPage" value="appealRecommendation"/>

		<sakai:heading>
			<logic:equal name="mdAdmissionForm" property="newTrackRecord.currentLevel" value="E"><fmt:message key="page.heading.executiveDeanOnAppeal"/></logic:equal>
			<logic:equal name="mdAdmissionForm" property="newTrackRecord.currentLevel" value="I"><fmt:message key="page.heading.ipsc"/></logic:equal>
		</sakai:heading>
		<sakai:messages/>
	<sakai:flat_list>
			<tr>
	...
	<sakai:flat_list>
			<tr>
				<th><fmt:message key="section.heading.previousRecommendationOnAppeal"/></th>
			</tr>
			<tr>
				<sakai:group_table>
					<tr>
					...
					<tr>
						<td>
							...
							<logic:equal name="mdAdmissionForm" property="application.recommendation.code" value="LE">						
								<bean:write name="mdAdmissionForm" property="application.requirementComment"/>
							</logic:equal>
	...
	<sakai:flat_list>
			<tr>
				<th><logic:equal name="mdAdmissionForm" property="newTrackRecord.currentLevel" value="E"><fmt:message key="section.heading.recommendation.executiveDean"/></logic:equal>
					<logic:equal name="mdAdmissionForm" property="newTrackRecord.currentLevel" value="I"><fmt:message key="section.heading.recommendation.ipsc"/></logic:equal>
				</th>
			</tr>
			<tr>
				<sakai:group_table>
					<tr>
						<th colspan="2"><fmt:message key="instruction.recommendation"/></th>
					</tr>
					<logic:iterate name="mdAdmissionForm" property="recommendationLongList" id="record" indexId="index">
						<tr>                         
							<td><html:radio property="newTrackRecord.recommendation.code" idName="record" value="code"></html:radio></td>								
