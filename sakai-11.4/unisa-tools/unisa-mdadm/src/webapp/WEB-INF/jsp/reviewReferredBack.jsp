...
<sakai:html>
	...
	<html:hidden property="currentPage" value="recommendation"/>

		<sakai:heading><fmt:message key="page.heading.reviewReferredBack"/></sakai:heading>
		<sakai:messages/>
	<sakai:flat_list>
			<tr>
	...
	<sakai:flat_list>
			<tr>
				<th><fmt:message key="section.heading.previousRecommendation"/></th>
			</tr>
			<tr>
				<sakai:group_table>
					<tr>
				...
				<sakai:group_table>
					<tr>
						<th><fmt:message key="subSection.heading.previousRecommendation.reason"/></th>
					</tr>
					<tr>
						<td><bean:write name="mdAdmissionForm" property="latestTrackRecord.signoffComment"/></td>
					</tr>
				</sakai:group_table>
			</tr>				
	</sakai:flat_list>				
			...
			<tr>
				<sakai:group_table>
					...
					<logic:iterate name="mdAdmissionForm" property="recommendationLongList" id="record" indexId="index">
						<logic:notEqual name="record" property="code" value="LN">
							<tr>                         
