...
<sakai:html>
	<sakai:tool_bar>
		...
		<html:link href="telecentre.do?action=activateCentres" >
			<fmt:message key="profile.activate.link.selected"/>
		</html:link>
	...
	<sakai:messages/>
	<sakai:heading>
	     <fmt:message key="profile.activate.heading"/>                
	</sakai:heading>
	<html:form action="/telecentre.do">
	<logic:notEqual name="telecentreForm" property="telActivateListTracker" value="1">
		<sakai:instruction>
