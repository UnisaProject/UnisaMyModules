...
<sakai:html>
	<sakai:heading>
	   <fmt:message key="profile.remove.confirm.heading"/>
	</sakai:heading>
	<sakai:messages/>
	<sakai:instruction>
	   <fmt:message key="profile.remove.confirm.instruction"/>
	</sakai:instruction>
	<html:form action="/telecentre.do">	
	<sakai:group_table>
		<sakai:group_heading>
			<fmt:message key="profile.remove.confirm.table.heading"/>
		</sakai:group_heading>
		<sakai:flat_list>
			<tr>
        ...
        <tr>
            <td>
             	<sakai:actions>
		           ...
		           <html:submit styleClass="button" property="action">
		           		<fmt:message key="profile.remove.confirm.submitBtn"/>
		           </html:submit>
	            </sakai:actions>
	        </td>	
		</tr>
