...
public String  monthToIntStr(String month){
 ...
 //Sifiso Changes:Added:2016/06/22-Method for use in 'TeleCentreAction.java' to get current seconds
 public int  getCurrSec(){
     GregorianCalendar calCurrent = new GregorianCalendar();
     return   calCurrent.get(Calendar.SECOND);	//Sifiso Changes: Get the current seconds
}
