...
public class UniflowFile {
	...
	private String uniflowVersion = "";	
	
	public String getUniflowVersion() {
		return uniflowVersion;
	}
	public void setUniflowVersion(String uniflowVersion) {
		this.uniflowVersion = uniflowVersion;
	}
