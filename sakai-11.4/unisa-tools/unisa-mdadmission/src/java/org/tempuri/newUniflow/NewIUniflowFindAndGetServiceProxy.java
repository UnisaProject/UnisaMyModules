...
public class NewIUniflowFindAndGetServiceProxy implements org.tempuri.newUniflow.NewIUniflowFindAndGetService {
  private String _endpoint = null;
  private org.tempuri.newUniflow.NewIUniflowFindAndGetService iUniflowFindAndGetService = null;
  
  public NewIUniflowFindAndGetServiceProxy() {
    _initIUniflowFindAndGetServiceProxy();
  }
  
  public NewIUniflowFindAndGetServiceProxy(String endpoint) {
    _endpoint = endpoint;
    _initIUniflowFindAndGetServiceProxy();
  }
  ...
  private void _initIUniflowFindAndGetServiceProxy() {
    try {
      iUniflowFindAndGetService = (new org.tempuri.newUniflow.NewUniflowFindAndGetServiceLocator()).getBasicHttpBinding_IUniflowFindAndGetService();
  ...
  public org.tempuri.newUniflow.NewIUniflowFindAndGetService getIUniflowFindAndGetService() {
    if (iUniflowFindAndGetService == null)
      _initIUniflowFindAndGetServiceProxy();
