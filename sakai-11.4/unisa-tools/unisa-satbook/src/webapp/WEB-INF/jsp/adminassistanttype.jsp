...
<sakai:html>
    ...
    <sakai:heading><fmt:message key="adminassistanttype.heading"/></sakai:heading>

	<sakai:messages/>
	<sakai:messages message="true"/>

	<logic:notEmpty name="adminForm" property="assistantTypeList">
	<sakai:flat_list>
		<tr>
			<td><fmt:message key="adminassistanttype.tableheading.type"/></td>
			<td><fmt:message key="adminmaterial.tableheading.active"/></td>
		</tr>
		<logic:iterate name="adminForm" property="assistantTypeList" id="record" indexId="i">
			<tr>
				<td>
					<html:radio property="selectedAssType" value="assTypeId" idName="record"/>
					<bean:write name="record" property="assTypeName"/>
				</td>
				<td><bean:write name="record" property="assTypeAct"/></td>
			</tr>
		</logic:iterate>
	</sakai:flat_list>
	</logic:notEmpty>
	...
	<sakai:actions>
		<html:submit property="action">
			<fmt:message key="adminassistanttype.button.add"/>
		</html:submit>
		<html:submit property="action">
			<fmt:message key="adminassistanttype.button.edit"/>
		</html:submit>
		<html:submit property="action">
			<fmt:message key="adminassistanttype.button.delete"/>
		</html:submit>
