...
<sakai:html>
	...
	<logic:equal name="bookingForm" property="systemID" value="${bookingForm.satbook}">
		...
		<b><fmt:message key="satbook.step3"/></b><br></br>
	...
	<logic:equal name="bookingForm" property="systemID" value="${bookingForm.venbook}" >
		...
		<b><fmt:message key="venbook.step2"/></b><br></br>
	...
	<sakai:instruction><fmt:message key="bookingstep3.instruction"/></sakai:instruction>
	<sakai:group_heading><fmt:message key="bookingstep3.materials"/></sakai:group_heading>
	<sakai:group_table>
		<logic:iterate name="bookingForm" property="materials" id="value" indexId="i">
			<tr>
				<td>
					<html:multibox property="selectedMaterials"><bean:write name="i"/></html:multibox>
