...
<sakai:html>
	...
	<sakai:group_table>
		<tr>
			...
			<td>
				<html:text name="classroom" property="regionDesc" size="20"></html:text>
			</td>
		</tr><tr>
			<td><fmt:message key="adminclassrooms.tableheading.contactperson"/> <sakai:required/></td>
			<td><html:text name="classroom" property="contactPerson" size="20"></html:text></td>
		</tr><tr>
			<td><fmt:message key="adminclassrooms.tableheading.contactnumber1"/> <sakai:required/></td>
			<td><html:text name="classroom" property="contactNum1" size="20"></html:text></td>
		</tr><tr>
			<td>
				<logic:equal name="satbookMonthlyForm" property="systemID" value="1">
					<fmt:message key="adminclassrooms.tableheading.contactnumber2"/>
				</logic:equal>
				<logic:equal name="satbookMonthlyForm" property="systemID" value="2">
					<fmt:message key="adminclassrooms.tableheading.email"/>
				</logic:equal>
			</td>
			<td><html:text name="classroom" property="contactNum2" size="20"></html:text></td>
		</tr><tr>
			...
			<td><fmt:message key="adminclassroomsedit.addresslinePcode"/></td>
