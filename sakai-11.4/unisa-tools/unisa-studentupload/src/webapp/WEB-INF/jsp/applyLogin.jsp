...
// 		}
	...
	function doSubmit(button){
		...
		if (button === "Continue"){
			...
			document.studentUploadForm.action='studentUpload.do?act=back';
			document.studentUploadForm.submit();
		}else if (button === "Cancel"){
			//document.studentUploadForm.action='studentUpload.do?act=cancel';
			//var url = "/unisa-studentupload/studentUpload.do?act=stepLoginSelect;
...
<html:form action="/studentUpload">
	...
	<input type="hidden" name="webOpenDate" id="webOpenDate" value="<bean:write name='studentUploadForm' property='student.webOpenDate' />"/>
	<input type="hidden" name="allowLogin" id="allowLogin" value="<bean:write name='studentUploadForm' property='allowLogin'/>"/>
	<input type="hidden" name="webLogMsg" id="webLogMsg" value="<bean:write name='studentUploadForm' property='webLoginMsg'/>"/>
					               	...
					               	<tr>
					            		...
					            		<td valign="bottom">
							              	<table style="width:100%">
							              		...
							              		<tr>
							              			<td>
							              				<html:select name="studentUploadForm" property="student.birthYear">
										 					<html:options collection="yearlist" property="value" labelProperty="label"/>
														</html:select>
													</td>
													<td>
							              				<html:select name="studentUploadForm" property="student.birthMonth">
										 					<html:options collection="monthlist" property="value" labelProperty="label"/>
														</html:select>
													</td>
													<td>
							              				<html:select name="studentUploadForm" property="student.birthDay">
	...
	<div style="display: none;" align="center"><bean:write name="studentUploadForm" property="version"/></div>
