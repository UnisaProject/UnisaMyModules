	...
	$(document).ready(function() {
		...
		$("#payLater").click(function(){
			...
			if (isAdmin === false || isAdmin === "false"){
				...
				window.top.location.href = "/unisa-studentupload/applyForStudentNumber.do?act=loginAdmin";
		  	}
		});		
	});
</script>
							...
							<td colspan="2">
								<table style="width:100%">
									<tr>
										...
										<td><bean:write name="studentUploadForm" property="student.newQualOneFinal"/></td>
									</tr><tr>
										<td style="width:165px; height:30px">Proposed Specialization:</td>
										<td><bean:write name="studentUploadForm" property="student.newSpecOneFinal"/></td>
									</tr><tr>
										<td style="width:165px; height:30px">Optional Qualification:</td>
										<td><bean:write name="studentUploadForm" property="student.newQualTwoFinal"/></td>
									</tr><tr>
										<td style="width:165px; height:30px">Optional Specialization:</td>
										<td><bean:write name="studentUploadForm" property="student.newSpecTwoFinal"/></td>
									</tr><tr>
