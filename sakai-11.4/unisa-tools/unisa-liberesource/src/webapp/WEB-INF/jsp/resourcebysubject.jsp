...
<link rel="stylesheet" type="text/css" href="https://my.unisa.ac.za/stylesheets/lib_e_resources.css" />	
	...
	<td>
    	<div class="subject-list">
        	<ul>
            	<logic:notEmpty name="libmainForm" property="dataList">
				<logic:iterate name="libmainForm" property="dataList" id="record" indexId="i">
                     <li><html:link href="resource.do?act=eresourcebySpecific&amp;status=main&amp;place=sub&amp;heading=${record.subject}&amp;selectedSubjectId=${record.subjectId}"><bean:write name="record" property="subject"/></html:link></li>
                </logic:iterate>
				</logic:notEmpty>
             </ul>
        </div>
