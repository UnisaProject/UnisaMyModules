...
<head>
	...
	function doSubmit(button){
		if (button === "Continue"){
			document.studentAppealForm.action='studentAppeal.do?act=applyLogin';
		}else if (button === "Back"){
			...
			//var url = "/unisa-studentappeal/studentAppeal.do?act=stepLoginSelect;
...
<html:form action="/studentAppeal">
	...
	<input type="hidden" name="webOpenDate" id="webOpenDate" value="<bean:write name='studentAppealForm' property='student.dateWAPAPL' />"/>
	<input type="hidden" name="allowLogin" id="allowLogin" value="<bean:write name='studentAppealForm' property='allowLogin'/>"/>
	<input type="hidden" name="webLogMsg" id="webLogMsg" value="<bean:write name='studentAppealForm' property='webLoginMsg'/>"/>
				...
				<div class="panel-body clearfix">
					...
					<div class="col-md-6 col-sm-6 col-xs-6 clearfix">
						<table style="width:100%;">
			               	<logic:equal name="studentAppealForm" property="allowLogin" value="true">
					               	<tr>
						              	<td style="width:180px;height:30px" valign="top"><fmt:message key="page.login.studnumber"/></td>
						              	<td style="height:30px"><html:text name="studentAppealForm" property="student.number" maxlength="8" size="24" onfocus="this.select();" />&nbsp;</td>
						            </tr><tr>
					              		<td style="width:180px;height:30px" valign="top"><fmt:message key="page.login.studsurname"/></td>
					              		<td valign="bottom"><html:text name="studentAppealForm" property="student.surname" maxlength="28" size="24"/>&nbsp;</td>
					            	</tr><tr>
					              		<td style="width:180px;height:30px" valign="top"><fmt:message key="page.login.studfullname"/></td>
					              		<td valign="bottom"><html:text name="studentAppealForm" property="student.firstnames" maxlength="60" size="24" onfocus="this.select();" />&nbsp;</td>
					            	</tr><tr>
					            		...
					            		<td valign="bottom">
							              	<table style="width:100%">
							              		...
							              		<tr>
							              			<td>
							              				<html:select name="studentAppealForm" property="student.birthYear">
										 					<html:options collection="yearlist" property="value" labelProperty="label"/>
														</html:select>
													</td>
													<td>
							              				<html:select name="studentAppealForm" property="student.birthMonth">
										 					<html:options collection="monthlist" property="value" labelProperty="label"/>
														</html:select>
													</td>
													<td>
							              				<html:select name="studentAppealForm" property="student.birthDay">
							...
							<logic:equal name="studentAppealForm" property="allowLogin" value="false">
								<tr>
									<td colspan="2"><strong><font color="red" size="large"><fmt:message key="page.login.appealClosed"/></font></strong></td>
						        </tr>
							</logic:equal>
			        	</table>
					</div>
