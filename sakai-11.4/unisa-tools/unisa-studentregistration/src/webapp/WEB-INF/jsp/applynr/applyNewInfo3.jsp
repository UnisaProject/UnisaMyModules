...
<html:form action="/applyForStudentNumber">
	<html:hidden property="page" value="applyNewInfo3"/>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">	
					<sakai:group_table>
						...
						<tr>
							<td colspan="2"><strong><fmt:message key="page.studentnr.apply.last"/></strong></td>
						</tr><tr>
							<td><fmt:message key="page.institution"/></td>
							<td>
								<html:select property="selectedPrevInstitution">
				 					<html:options collection="universitylist" property="value" labelProperty="label"/>
								</html:select>
							</td>
						</tr><tr>
							<td><fmt:message key="page.studentnr.apply.last.regyear"/></td>
							<td><html:text name="studentRegistrationForm" property="student.lastRegYear" maxlength="4" size="5"/></td>
						</tr><tr>
							<td><fmt:message key="page.studentnr.apply.last.reg"/></td>
							<td>
								<html:radio property="student.lastStatus" value="U"/><fmt:message key="page.undergrad"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<html:radio property="student.lastStatus" value="P"/><fmt:message key="page.postgrad"/>
							</td>
						</tr><tr>
							<td><fmt:message key="page.apply.prevstudnumber"/></td>
							<td><html:text name="studentRegistrationForm" property="studentApplication.previnstStudnr" maxlength="10" size="15"/></td>
						</tr><tr>
