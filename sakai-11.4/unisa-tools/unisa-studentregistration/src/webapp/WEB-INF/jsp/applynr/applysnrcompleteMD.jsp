...
<head>
	...
	<script type="text/javascript" src="<c:url value='/resources/js/jquery.timer.js' />"></script>
							...
							<td colspan="2">
								<table style="width:100%">
									<tr>
										...
										<td><bean:write name="studentRegistrationForm" property="student.newMDQualFinal"/></td>
									</tr><tr>
										<td style="width:165px; height:30px">Proposed Specialization:</td>
										<td><bean:write name="studentRegistrationForm" property="student.newMDSpecFinal"/></td>
									</tr><tr>
