...
public class UploadAction extends DispatchAction {
	...
	public void reLoad(StudentRegistrationForm form) throws Exception{
		...
		savedDocDao.getAllNonRequiredDocInfo(form.getDesc(), form.getMap(), form.getStudent().getNumber(),form.getStudent().getAcademicYear(),form.getStudent().getAcademicPeriod(),form.getStudent().getStuExist());
