...
public class WorkflowTempFile {
	...
	*/
	...
	public WorkflowTempFile(String fileName, String fileType) {
		...
		if(fileType == null || "".equals(fileType)){
		...
		}else if ("APP".equalsIgnoreCase(fileType)){
		  ...
		  filePath = ServerConfigurationService.getString("application.path");
			...
			// HONS application workflow path
			  filePath = ServerConfigurationService.getString("honapply.path");
		}else if ("PG".equalsIgnoreCase(fileType)){
			// PG application workflow path
			  filePath = ServerConfigurationService.getString("pgapply.path");
		}else if ("SLP".equalsIgnoreCase(fileType)){
			// SLP application workflow path
			  filePath = ServerConfigurationService.getString("slpapply.path");
		}else if ("SBL".equalsIgnoreCase(fileType)){
			// SBL application workflow path
