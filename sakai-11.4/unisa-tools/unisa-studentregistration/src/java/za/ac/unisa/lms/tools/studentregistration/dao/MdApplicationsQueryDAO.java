...
import za.ac.unisa.lms.tools.studentregistration.forms.MdPrev;
...
public class MdApplicationsQueryDAO extends StudentSystemDAO {
	 ...
	 */
	public ArrayList<LabelValueBean> getQualList(String applyType, String sYear)
			throws Exception {
...
//      + "and substr(regdat.type,7,1) = grd.under_post_categor "
	 ...
	 */
	public ArrayList<LabelValueBean> getSpesList(String sQual, String sYear) throws Exception {
		ArrayList<LabelValueBean> list = new ArrayList<LabelValueBean>();
	 ...
	 */
	public ArrayList<LabelValueBean> getInterestAreas(String qualCode, String specCode) throws Exception {
		ArrayList<LabelValueBean> list = new ArrayList<LabelValueBean>();
	 ...
	 * This method returns a list of disabilities
	 */
	public ArrayList<LabelValueBean> getOtherUniversities() throws Exception {
		ArrayList<LabelValueBean> list = new ArrayList<LabelValueBean>();
	 ...
	 */
	public ArrayList<LabelValueBean> getExaminationCentreList() throws Exception {
		ArrayList<LabelValueBean> list = new ArrayList<LabelValueBean>();
	...
	private ArrayList<LabelValueBean> readDatabase(String query){
		ArrayList<LabelValueBean> list = new ArrayList<LabelValueBean>();
	...
	public void updMDrecordOld(Student stu, String qcode, String scode) throws Exception {
		StudentRegistrationForm mdForm = new StudentRegistrationForm();
	...
	public List<MdPrev> getMDhistory(String studentNr, String seqnr) throws Exception{
		String sql;
		List<MdPrev> histList = new ArrayList<MdPrev>();
