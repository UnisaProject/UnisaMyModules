...
<sakai:html>
	...
	<html:form action="/smsEnquiry">
		<html:hidden property="currentPage" value="batchList"/>
		<sakai:messages/>
		...
		<sakai:group_table>	
			...
			<tr>
				...
				<td><bean:write name="smsEnquiryForm" property="dateSent"/></td>
			</tr>
			<tr>
		...
		<sakai:flat_list>
			...
			<tr>
				<th><fmt:message key="page.log.colheading.refNr"/></th>
				<th><fmt:message key="page.log.colheading.cellNr"/></th>
			...
			<logic:iterate name="smsEnquiryForm" property="listSmsLog" id="record" indexId="index">
				...
				<tr>					
					<td>
						<bean:write name="record" property="referenceNr"/>
						<html:link href="smsEnquiry.do?action=getLogEntryDetail" name="paramsName">
							<fmt:message key="link.view"/>	
						</html:link></td>
					<td><bean:write name="record" property="cellNr"/></td>
