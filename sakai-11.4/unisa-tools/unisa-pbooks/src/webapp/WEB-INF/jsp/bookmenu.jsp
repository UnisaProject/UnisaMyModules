...
<sakai:html>
	...
	<html:form action="/prebook">
	       ...
	       <sakai:instruction>
		         <fmt:message key="label.frmbookmensssuinstr"/>
	       </sakai:instruction>
	       <html:select name="bookMenuForm"  property="acadyear" onchange = "submit();">
    		...
    		<html:select name="bookMenuForm" property="selectedCourse" disabled="true">
    		...
    		<html:hidden property="selectedCourse" value="Select Course Code"/>
    		<html:hidden property="acadyear" value="Select Academic Year"/>
		  <p/>
     </html:form>
</sakai:html>