...
<fmt:setBundle basename="za.ac.unisa.lms.tools.booklist.ApplicationResources"/>
  	  ...
  	  <sakai:heading><fmt:message key="booksite.heading1"/>
		...
		<bean:write name="booklistForm" property="year"/>
			...
			<bean:write name="booklistForm" property="status"/></sakai:heading>
			
			<sakai:instruction>
		<fmt:message key="booksite.school.instruction"/>
		 	</sakai:instruction>   
...
<tr>
  ...
  <tr>
	...
	<logic:notEqual name="booklistForm" property="viewStudyUnits" value="m">
		<logic:empty name="booklistForm" property="someprescribedBooks">
				<fmt:message key="booksite.notavailable"/>
	</logic:empty>	
	</logic:notEqual>
