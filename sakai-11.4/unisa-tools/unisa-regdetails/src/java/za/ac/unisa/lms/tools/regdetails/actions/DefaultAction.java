...
public class DefaultAction extends DispatchAction {
	...
	public ActionForward execute(
		...
		//See unisa-findtool for more info on how "returnedFrom" parameter is set
		String originatedFrom =  request.getParameter("returnedFrom");
		if (originatedFrom != null && "unisa.biodetails".equals(originatedFrom))
		{
