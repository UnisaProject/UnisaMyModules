...
//	private Address physicalAddress = new Address();
	private Address courierAddressPrev = new Address(); //Keeps previous Address
	private Address courierAddress = new Address(); //Keeps new/changed Address
	...
	public String getContactNrPrev() {
		return contactNrPrev;
	}
	public void setContactNrPrev(String contactNrPrev) {
		this.contactNrPrev = contactNrPrev;
	}
...
//	}
	public Address getCourierAddressPrev() {
		return courierAddressPrev;
	}
	public void setCourierAddressPrev(Address courierAddressPrev) {
		this.courierAddressPrev = courierAddressPrev;
	}
