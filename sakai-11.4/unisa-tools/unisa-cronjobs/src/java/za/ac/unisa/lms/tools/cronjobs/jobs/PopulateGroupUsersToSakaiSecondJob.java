...
public class PopulateGroupUsersToSakaiSecondJob extends SingleClusterInstanceJob implements StatefulJob, InterruptableJob, OutputGeneratingJob {
	...
	public void populateUsers() throws Exception{
		...
		PopulateUsersStudentSystemDAO populateUsersStudentSystemDAO = new PopulateUsersStudentSystemDAO();
		  ...
		  try{	
			  ...
			  userCourseList = populateUsersStudentSystemDAO.getStudentGroupRecordsWithout63And62();	//Not 3 and 5
