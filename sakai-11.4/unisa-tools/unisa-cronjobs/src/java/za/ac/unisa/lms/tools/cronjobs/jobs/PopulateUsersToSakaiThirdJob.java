...
public class PopulateUsersToSakaiThirdJob extends SingleClusterInstanceJob implements StatefulJob, InterruptableJob, OutputGeneratingJob {
	...
	public void populateUsers() throws Exception{
		...
		PopulateUsersStudentSystemDAO populateUsersStudentSystemDAO = new PopulateUsersStudentSystemDAO();
		  ...
		  try{	
			  ...
			  userCourseList = populateUsersStudentSystemDAO.getStudentRecordsStartsWith5();	//stusun starts with 5 
