package za.ac.unisa.lms.tools.cronjobs.dao;
	...
	public class StudentTelecentre{
			...
			//Sifiso Changes:Changed line below:2016/07/05-Changed type for 'usedHours' variable from int to double
			...
			//Sifiso Changes:Changed line below:2016/07/05-Changed type for method parameter from int to double
			//public void setUsedHours(int usedHours){
			public void setUsedHours(double usedHours){		//Sifiso Changes
				this.usedHours=usedHours;
			}
			//Sifiso Changes:Changed line below:2016/07/05-Changed method return type from int to double
