...
public class PopulateUsersToSakaiJob extends SingleClusterInstanceJob implements StatefulJob, InterruptableJob, OutputGeneratingJob {
	...
	public void populateUsers() throws Exception{
		...
		PopulateUsersStudentSystemDAO populateUsersStudentSystemDAO = new PopulateUsersStudentSystemDAO();
		  ...
		  try{	
			  ...
			  userCourseList = populateUsersStudentSystemDAO.getStudentCourseRecords();	//stusun not like 5 or 6 or 4 
			  ...
			  while (courseList.hasNext()) {					 
				 ...
				 try{
					 ...
					 if(action.equalsIgnoreCase("DELETE")){
						 String status = removeUserToSite(siteId,userId,"Student");
   ...
   public String removeUserToSite(String siteId, String eId,String userRole) throws Exception{
