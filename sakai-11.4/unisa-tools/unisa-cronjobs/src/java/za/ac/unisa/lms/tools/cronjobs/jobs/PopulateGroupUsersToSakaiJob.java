...
public class PopulateGroupUsersToSakaiJob extends SingleClusterInstanceJob implements StatefulJob, InterruptableJob, OutputGeneratingJob {
	...
	public void populateUsers() throws Exception{
		...
		PopulateUsersStudentSystemDAO populateUsersStudentSystemDAO = new PopulateUsersStudentSystemDAO();
		  ...
		  try{	
			  ...
			  userCourseList = populateUsersStudentSystemDAO.getStudentGroupRecordsWith63And62();	//stusun like 3 and 5
