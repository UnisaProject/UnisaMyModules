...
<html:form action="/maintenance"> 
	<html:hidden property="atstep" value="highlight"/>
	
	<sakai:group_heading>
		<fmt:message key="heading"/> <br>
		<fmt:message key="main.heading1"/><fmt:message key="high.heading"/>
	</sakai:group_heading>
	<p>
	<sakai:messages/>
	...
	<sakai:flat_list>
		<tr>
			...
			<th><fmt:message key="high.note"/></th>
		...
		<logic:notEmpty name="maintenanceForm" property="dataList">
			<logic:iterate name="maintenanceForm" property="dataList" id="record" indexId="i">
				<tr>
					...
					<td><bean:write name="record" property="highId"/></td>
					<td><bean:write name="record" property="highlight"/></td>
