...
<sakai:html>
		...
		<hr></hr>
		<sakai:group_heading>
			<fmt:message key ="mis.teach"/> <bean:write name="misForm" property="selectedYear"/>
		</sakai:group_heading>
		<sakai:group_heading>
		...
		<sakai:flat_list>
				...
				<tr>
					<td><fmt:message key ="teach.tools1"/></td>
			...
			<br><br>
			<b><fmt:message key ="teach.tools12"></fmt:message></b>
</sakai:html>