...
<sakai:html>
	<html:form action="/smsQuery">
		<html:hidden property="currentPage" value="cellNumSelectedPage"/>
		<html:hidden property="prevPage" value="cellNumSelectedPage"/>
		<sakai:messages/>
		 ...
		 <logic:notEmpty name="smsQueryForm"  property="displayList">
			...
			<logic:iterate name="smsQueryForm" property="displayList" id="record" indexId="index">
				...
				<tr>						
					...
					<td width="35%"><bean:write name="record" property="message"/></td>					
			</tr>
			</logic:iterate>
		  </sakai:flat_list>
		  </logic:notEmpty>
