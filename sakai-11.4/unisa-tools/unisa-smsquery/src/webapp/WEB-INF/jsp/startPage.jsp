...
<sakai:html>
	<!-- Toolbar -->
	<sakai:tool_bar>
		<html:link href="smsQuery.do?action=inputSmsBatchSearch">
	...
	<html:form action="/smsQuery">
		...
		<sakai:group_table>	
			<tr>
				...
				<td><html:text name="smsQueryForm" property="searchBatchNumber" size="20" maxlength="7"/></td>
			</tr>
			<tr>
				<td><fmt:message key="page.option2"/></td>
				<td><html:text name="smsQueryForm" property="searchStudentNumber" size="20" maxlength="8"/></td>
			</tr>
			<tr>
				<td><fmt:message key="page.option3"/></td>
				<td><html:text name="smsQueryForm" property="searchCellNumber" size="20" maxlength="20"/><fmt:message key="page.option3.eg"/></td>
			</tr>
		</sakai:group_table>
		<sakai:actions>
