	...
	<html:form action="/smsQuery">
		...
		<sakai:group_table>	
			...
			<tr>
				...
				<td><bean:write name="smsQueryForm" property="senderName"/></td>
			</tr>
			<tr>
				<td><fmt:message key="page.sender.email"/></td>
				<td><bean:write name="smsQueryForm" property="senderEmail"/></td>
			</tr>
			<tr>
				<td><fmt:message key="page.sender.telno"/></td>
				<td><bean:write name="smsQueryForm" property="senderPhoneNumber"/></td>
			</tr>
			<tr>		
				<td colspan="2"><sakai:heading>
			...
			<tr>
				...
				<td><bean:write name="smsQueryForm" property="batchNumber"/></td>
			</tr>
			<tr>
				<td><fmt:message key="page.message"/></td>
				<td><bean:write name="smsQueryForm" property="message"/></td>
			</tr>			
			<tr>		
				<td colspan="2"><sakai:heading>
			...
			<tr>
				...
				<td><bean:write name="smsQueryForm" property="smsStatus"/></td>
			</tr>
			<tr>
				<td><fmt:message key="page.sms.desc"/></td>
				<td><bean:write name="smsQueryForm" property="smsStatusDesc"/></td>
			</tr>			
		</sakai:group_table>
		<sakai:actions>
