...
public String  monthToIntStr(String month){
 ...
 public String todayDateStr(){
	     return  ""+yearInt()+"-"+getMonthIntStr()+"-"+getDayIntStr(getDayOfMonthInt());
 }
 ...
 public ArrayList <LabelValueBean>  getYearsList(){
   ...
   public boolean validateYear(String year){
	              if(isInteger(year)&&(year.length()==4)){
	            	 return true; 
	              }else{
	            	  return false;
	              }
   ...
   public boolean validateMonth(String month){
	               if(isInteger(month)&&(month.length()==2)&&
	            		   (Integer.parseInt(month)<13)&&(Integer.parseInt(month)>0)){
      	                     return true; 
                   }else{
      	                    return false;
                   }
   ...
   public boolean validateDay(String day){
	               if(isInteger(day)&&(day.length()==2)&&
    		                (Integer.parseInt(day)<32)&&(Integer.parseInt(day)>0)){
                               return true; 
                   }else{
                               return false;
                    }
   ...
   public boolean validateDateYYYYMMDD(String dateStr){
	                    ...
	                    if(dateStr.length()==8){
	                    	 String century=dateStr.substring(0,4);
			                 String month=dateStr.substring(4,6);
			                 String day=dateStr.substring(6);
			                 if(validateYear(century)&&validateMonth(month)&&validateDay(day)){
			                      formatCorrect= true;
			                 }
	                    }
   ...
   public String  to_YYYYMMDD(String dateStr){
                      String century=dateStr.substring(0,4);
                      String month=dateStr.substring(5,7);
                      String day=dateStr.substring(8);
                      return century+month+day;
   }
