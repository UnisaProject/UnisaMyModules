package za.ac.unisa.lms.tools.smsquery.forms;
...
public class SmsQueryForm extends ValidatorForm {	
		
		private static final long serialVersionUID = 1L;
		private String currentPage="",prevPage="";
		private String novellUserId;
		private String batchNumber;
		private String studentNumber;
		private String cellNumber;
		private String dateSent;
		private String view="All items";
		private String message;
		private List listSmsLog;
		private List listSmsRequest;
		private ArrayList batchesList,displayList;
		...
		private String sentSms,filterMessage="";
		private boolean stuNumFirstEntry=true,cellNumFirstEntry=true,batchNumFirstEntry=true,batchListFirstEntry=true;
		...
		public boolean isBatchNumFirstEntry(){
			 return batchNumFirstEntry;
		}
		public void setBatchNumFirstEntry(boolean batchNumFirstEntry){
			   this.batchNumFirstEntry=batchNumFirstEntry;
		}
		public boolean isStuNumFirstEntry(){
			 return stuNumFirstEntry;
		}
		public void setStuNumFirstEntry(boolean stuNumFirstEntry){
			   this.stuNumFirstEntry=stuNumFirstEntry;
		}
		public boolean isCellNumFirstEntry(){
			 return cellNumFirstEntry;
		}
		public void setCellNumFirstEntry(boolean cellNumFirstEntry){
			   this.cellNumFirstEntry=cellNumFirstEntry;
		}
		public boolean isBatchListFirstEntry(){
			 return batchListFirstEntry;
		}
		public void setBatchListFirstEntry(boolean batchListFirstEntry){
			   this.batchListFirstEntry=batchListFirstEntry;
		}
		public Object getDisplayIndex(int index){
		...
		public ArrayList getBatchesList() {
			return batchesList;
		}
		public void setBatchesList(ArrayList batchesList) {
