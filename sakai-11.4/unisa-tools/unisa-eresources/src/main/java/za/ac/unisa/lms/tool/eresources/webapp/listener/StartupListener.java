package za.ac.unisa.lms.tool.eresources.webapp.listener;
...
public class StartupListener implements ServletContextListener {
    ...
    public static void setupContext(ServletContext context) {
        ...
        //Eresource Application specific Drop-down lists
        VendorManager vendorManager = (VendorManager) ctx.getBean("vendorManager");
        ContentTypeManager contentTypeManager = (ContentTypeManager) ctx.getBean("contentTypeManager");
        NewsletterManager newsletterManager = (NewsletterManager) ctx.getBean("newsletterManager");
        PlacementManager placementManager = (PlacementManager) ctx.getBean("placementManager");
        SubjectsManager subjectsManager = (SubjectsManager) ctx.getBean("subjectsManager");
        HighlightNotesManager highlightNotesManager = (HighlightNotesManager) ctx.getBean("highlightNotesManager");
        
        
        // get list of possible roles
        context.setAttribute(Constants.AVAILABLE_ROLES, mgr.getAllRoles());
        context.setAttribute("vendors", vendorManager.getAll());
        context.setAttribute("contentTypes",contentTypeManager.getAll());
        context.setAttribute("newsletters", newsletterManager.getAll());
        context.setAttribute("placements", placementManager.getAll());
        context.setAttribute("subjects", subjectsManager.getAll());
        context.setAttribute("highlightNotes", highlightNotesManager.getAll());
