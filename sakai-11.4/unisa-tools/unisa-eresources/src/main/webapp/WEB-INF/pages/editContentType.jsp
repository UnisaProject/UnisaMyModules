...
<div class="span2">
    ...
    <h3><fmt:message key='contentTypeDetail.heading.edit'/></h3>
</div>
<div class="span7">
    <form:errors path="*" cssClass="alert alert-error fade in" element="div"/>
    <form:form commandName="editContentType" method="post" action="contenttypeform" id="contentTypeForm"  cssClass="well form-horizontal"  onsubmit="return validateContentType(this)">
    <form:hidden path="libTxtID"/>
    <spring:bind path="fullTxtDescr">
