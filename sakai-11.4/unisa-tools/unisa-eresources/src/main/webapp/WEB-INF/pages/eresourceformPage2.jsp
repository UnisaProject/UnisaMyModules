...
<div class="span7">
    ...
    <form:form commandName="eresource" method="post" action="submitEResourceForm2" id="eresource2"
         ...
         <c:forEach items="${placements}" var="placement">
            <div class="controls">
            	<label class="checkbox inline">
            		<form:checkbox path="eresourcePlacementIds" value="${placement.placementId}"/>${placement.placement}
            	</label>
            </div>
         </c:forEach>
        </fieldset>
