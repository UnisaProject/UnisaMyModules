 ...
 */
public class Exerq40sRmkApplManagement  implements ActionListener, java.io.Serializable  {
 
   //  Use final String for the bean name
   public static final String BEANNAME = new String("Exerq40sRmkApplManagement");
   ...
   public Exerq40sRmkApplManagement() {
      super();
   ...
   private Exerq40sRmkApplManagementOperation oper = null;
   ...
   public void execute()  throws PropertyVetoException {
      try  {
         if (oper == null) {
            oper = new Exerq40sRmkApplManagementOperation(this);
         ...
         oper.doExerq40sRmkApplManagementOperation();
   ...
   private class operListener implements ActionListener, java.io.Serializable  {
      private Exerq40sRmkApplManagement rP;
      operListener(Exerq40sRmkApplManagement r)  {
         rP = r;
      }
      public void actionPerformed(ActionEvent aEvent)  {
         if (Trace.isTracing(Trace.MASK_APPLICATION))
         {
            Trace.record(Trace.MASK_APPLICATION, "Exerq40sRmkApplManagement", "Listener heard that Exerq40sRmkApplManagementOperation completed with " + 
   ...
   private void notifyCompletionListeners()  {
      if (Trace.isTracing(Trace.MASK_APPLICATION))
      {
         Trace.record(Trace.MASK_APPLICATION, BEANNAME, "notifying listeners of completion of operation Exerq40sRmkApplManagement ()\n");
      }
      Vector targets;
      ...
      actionEvt = new ActionEvent(this, 0, "Completion.Exerq40sRmkApplManagement");
   ...
   private void notifyExceptionListeners(String s)  {
      if (Trace.isTracing(Trace.MASK_APPLICATION))
      {
         Trace.record(Trace.MASK_APPLICATION, BEANNAME, "notifying listeners of exception of operation Exerq40sRmkApplManagement ()\n");
      }
      Vector targets;
      ActionEvent actionEvt = null;
      String failCommand = "Exception.Exerq40sRmkApplManagement";
      synchronized (this)  {
   ...
   public void clear()  throws PropertyVetoException  {
      ...
      importView.reset();
      exportView.reset();
      importView.InRemarkGroup_MA = IntAttr.valueOf(InRemarkGroupMax);
      exportView.OutRemarkGroup_MA = IntAttr.getDefaultValue();
      exportView.OutStatusGroup_MA = IntAttr.getDefaultValue();
   }

   Exerq40h.IMP52223_IA importView = Exerq40h.IMP52223_IA.getInstance();
   Exerq40h.IMP52223_OA exportView = Exerq40h.IMP52223_OA.getInstance();
   ...
   public final int InRemarkGroupMax = 25;
   public short getInRemarkGroupCount() {
      return (short)(importView.InRemarkGroup_MA);
   };
 
   public void setInRemarkGroupCount(short s) throws PropertyVetoException {
      if (s < 0 || s > InRemarkGroupMax) {
         throw new PropertyVetoException("InRemarkGroupCount value is not a valid value. (0 to 25)",
               new PropertyChangeEvent (this, "InRemarkGroupCount", null, null));
      } else {
         importView.InRemarkGroup_MA = IntAttr.valueOf((int)s);
      }
   }
 
   public short getInRmkGWsUnisaCollegeCode(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return importView.InRmkGWsUnisaCollegeCode[index];
   }
   public void setInRmkGWsUnisaCollegeCode(int index, short s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      if (java.lang.Math.abs(s) >= 1000.0) {
         throw new PropertyVetoException("InRmkGWsUnisaCollegeCode has more than 3 digits.",
               new PropertyChangeEvent (this, "InRmkGWsUnisaCollegeCode", null, null));
      }
      importView.InRmkGWsUnisaCollegeCode[index] = ShortAttr.valueOf(s);
   }
   public void setAsStringInRmkGWsUnisaCollegeCode(int index, String s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("InRmkGWsUnisaCollegeCode is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InRmkGWsUnisaCollegeCode", null, null));
      }
      try {
          setInRmkGWsUnisaCollegeCode(index, Short.parseShort(s) );
      } catch (NumberFormatException e) {
          throw new PropertyVetoException("InRmkGWsUnisaCollegeCode is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InRmkGWsUnisaCollegeCode", null, null));
      }
   ...
   public String getInRmkGWsUnisaCollegeAbbreviation(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return FixedStringAttr.valueOf(importView.InRmkGWsUnisaCollegeAbbreviation[index], 10);
   }
   public void setInRmkGWsUnisaCollegeAbbreviation(int index, String s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      ...
      if (s.length() > 10) {
         throw new PropertyVetoException("InRmkGWsUnisaCollegeAbbreviation must be <= 10 characters.",
               new PropertyChangeEvent (this, "InRmkGWsUnisaCollegeAbbreviation", null, null));
      }
      importView.InRmkGWsUnisaCollegeAbbreviation[index] = FixedStringAttr.valueOf(s, (short)10);
   }
 
   public short getInRmkGWsUnisaSchoolCode(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return importView.InRmkGWsUnisaSchoolCode[index];
   }
   public void setInRmkGWsUnisaSchoolCode(int index, short s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      if (java.lang.Math.abs(s) >= 1000.0) {
         throw new PropertyVetoException("InRmkGWsUnisaSchoolCode has more than 3 digits.",
               new PropertyChangeEvent (this, "InRmkGWsUnisaSchoolCode", null, null));
      }
      importView.InRmkGWsUnisaSchoolCode[index] = ShortAttr.valueOf(s);
   }
   public void setAsStringInRmkGWsUnisaSchoolCode(int index, String s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("InRmkGWsUnisaSchoolCode is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InRmkGWsUnisaSchoolCode", null, null));
      }
      try {
          setInRmkGWsUnisaSchoolCode(index, Short.parseShort(s) );
      } catch (NumberFormatException e) {
          throw new PropertyVetoException("InRmkGWsUnisaSchoolCode is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InRmkGWsUnisaSchoolCode", null, null));
      }
   ...
   public String getInRmkGWsUnisaSchoolAbbreviation(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return FixedStringAttr.valueOf(importView.InRmkGWsUnisaSchoolAbbreviation[index], 20);
   }
   public void setInRmkGWsUnisaSchoolAbbreviation(int index, String s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      ...
      if (s.length() > 20) {
         throw new PropertyVetoException("InRmkGWsUnisaSchoolAbbreviation must be <= 20 characters.",
               new PropertyChangeEvent (this, "InRmkGWsUnisaSchoolAbbreviation", null, null));
      }
      importView.InRmkGWsUnisaSchoolAbbreviation[index] = FixedStringAttr.valueOf(s, (short)20);
   }
 
   public short getInRmkGWsDepartmentCode(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return importView.InRmkGWsDepartmentCode[index];
   }
   public void setInRmkGWsDepartmentCode(int index, short s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      if (java.lang.Math.abs(s) >= 1000.0) {
         throw new PropertyVetoException("InRmkGWsDepartmentCode has more than 3 digits.",
               new PropertyChangeEvent (this, "InRmkGWsDepartmentCode", null, null));
      }
      importView.InRmkGWsDepartmentCode[index] = ShortAttr.valueOf(s);
   }
   public void setAsStringInRmkGWsDepartmentCode(int index, String s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("InRmkGWsDepartmentCode is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InRmkGWsDepartmentCode", null, null));
      }
      try {
          setInRmkGWsDepartmentCode(index, Short.parseShort(s) );
      } catch (NumberFormatException e) {
          throw new PropertyVetoException("InRmkGWsDepartmentCode is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InRmkGWsDepartmentCode", null, null));
      }
   ...
   public String getInRmkGWsDepartmentEngDescription(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return FixedStringAttr.valueOf(importView.InRmkGWsDepartmentEngDescription[index], 28);
   }
   public void setInRmkGWsDepartmentEngDescription(int index, String s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      if (s.length() > 28) {
         throw new PropertyVetoException("InRmkGWsDepartmentEngDescription must be <= 28 characters.",
               new PropertyChangeEvent (this, "InRmkGWsDepartmentEngDescription", null, null));
      }
      importView.InRmkGWsDepartmentEngDescription[index] = FixedStringAttr.valueOf(s, (short)28);
   }
 
   public int getInRmkGExamReMarkMkStudentNr(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return importView.InRmkGExamReMarkMkStudentNr[index];
   }
   public void setInRmkGExamReMarkMkStudentNr(int index, int s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      if (java.lang.Math.abs(s) >= 100000000.0) {
         throw new PropertyVetoException("InRmkGExamReMarkMkStudentNr has more than 8 digits.",
               new PropertyChangeEvent (this, "InRmkGExamReMarkMkStudentNr", null, null));
      }
      importView.InRmkGExamReMarkMkStudentNr[index] = IntAttr.valueOf(s);
   }
   public void setAsStringInRmkGExamReMarkMkStudentNr(int index, String s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("InRmkGExamReMarkMkStudentNr is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InRmkGExamReMarkMkStudentNr", null, null));
      }
      try {
          setInRmkGExamReMarkMkStudentNr(index, Integer.parseInt(s) );
      } catch (NumberFormatException e) {
          throw new PropertyVetoException("InRmkGExamReMarkMkStudentNr is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InRmkGExamReMarkMkStudentNr", null, null));
      }
   ...
   public String getInRmkGExamReMarkMkStudyUnitCode(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return FixedStringAttr.valueOf(importView.InRmkGExamReMarkMkStudyUnitCode[index], 7);
   }
   public void setInRmkGExamReMarkMkStudyUnitCode(int index, String s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      ...
      if (s.length() > 7) {
         throw new PropertyVetoException("InRmkGExamReMarkMkStudyUnitCode must be <= 7 characters.",
               new PropertyChangeEvent (this, "InRmkGExamReMarkMkStudyUnitCode", null, null));
      }
      importView.InRmkGExamReMarkMkStudyUnitCode[index] = FixedStringAttr.valueOf(s, (short)7);
   }
 
   public short getInRmkGExamReMarkPrintBatch(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return importView.InRmkGExamReMarkPrintBatch[index];
   }
   public void setInRmkGExamReMarkPrintBatch(int index, short s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      if (java.lang.Math.abs(s) >= 10000.0) {
         throw new PropertyVetoException("InRmkGExamReMarkPrintBatch has more than 4 digits.",
               new PropertyChangeEvent (this, "InRmkGExamReMarkPrintBatch", null, null));
      }
      importView.InRmkGExamReMarkPrintBatch[index] = ShortAttr.valueOf(s);
   }
   public void setAsStringInRmkGExamReMarkPrintBatch(int index, String s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("InRmkGExamReMarkPrintBatch is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InRmkGExamReMarkPrintBatch", null, null));
      }
      try {
          setInRmkGExamReMarkPrintBatch(index, Short.parseShort(s) );
      } catch (NumberFormatException e) {
          throw new PropertyVetoException("InRmkGExamReMarkPrintBatch is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InRmkGExamReMarkPrintBatch", null, null));
      }
   ...
   public String getInRmkGStudentNameCsfStringsString28(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return FixedStringAttr.valueOf(importView.InRmkGStudentNameCsfStringsString28[index], 28);
   }
   public void setInRmkGStudentNameCsfStringsString28(int index, String s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      if (s.length() > 28) {
         throw new PropertyVetoException("InRmkGStudentNameCsfStringsString28 must be <= 28 characters.",
               new PropertyChangeEvent (this, "InRmkGStudentNameCsfStringsString28", null, null));
      }
      importView.InRmkGStudentNameCsfStringsString28[index] = FixedStringAttr.valueOf(s, (short)28);
   }
 
   public short getInRmkGExamPaperDetailsNr(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return importView.InRmkGExamPaperDetailsNr[index];
   }
   public void setInRmkGExamPaperDetailsNr(int index, short s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      if (java.lang.Math.abs(s) >= 10.0) {
         throw new PropertyVetoException("InRmkGExamPaperDetailsNr has more than 1 digits.",
               new PropertyChangeEvent (this, "InRmkGExamPaperDetailsNr", null, null));
      }
      importView.InRmkGExamPaperDetailsNr[index] = ShortAttr.valueOf(s);
   }
   public void setAsStringInRmkGExamPaperDetailsNr(int index, String s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("InRmkGExamPaperDetailsNr is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InRmkGExamPaperDetailsNr", null, null));
      }
      try {
          setInRmkGExamPaperDetailsNr(index, Short.parseShort(s) );
      } catch (NumberFormatException e) {
          throw new PropertyVetoException("InRmkGExamPaperDetailsNr is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InRmkGExamPaperDetailsNr", null, null));
      }
   ...
   public String getInRmkGStatusWsGenericCodeCode(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return FixedStringAttr.valueOf(importView.InRmkGStatusWsGenericCodeCode[index], 10);
   }
   public void setInRmkGStatusWsGenericCodeCode(int index, String s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      ...
      if (s.length() > 10) {
         throw new PropertyVetoException("InRmkGStatusWsGenericCodeCode must be <= 10 characters.",
               new PropertyChangeEvent (this, "InRmkGStatusWsGenericCodeCode", null, null));
      }
      importView.InRmkGStatusWsGenericCodeCode[index] = FixedStringAttr.valueOf(s, (short)10);
   }
 
   public String getInRmkGShelfCsfStringsString7(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return FixedStringAttr.valueOf(importView.InRmkGShelfCsfStringsString7[index], 7);
   }
   public void setInRmkGShelfCsfStringsString7(int index, String s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      ...
      if (s.length() > 7) {
         throw new PropertyVetoException("InRmkGShelfCsfStringsString7 must be <= 7 characters.",
               new PropertyChangeEvent (this, "InRmkGShelfCsfStringsString7", null, null));
      }
      importView.InRmkGShelfCsfStringsString7[index] = FixedStringAttr.valueOf(s, (short)7);
   }
 
   public String getInRmkGDateCsfStringsString10(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return FixedStringAttr.valueOf(importView.InRmkGDateCsfStringsString10[index], 10);
   }
   public void setInRmkGDateCsfStringsString10(int index, String s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      ...
      if (s.length() > 10) {
         throw new PropertyVetoException("InRmkGDateCsfStringsString10 must be <= 10 characters.",
               new PropertyChangeEvent (this, "InRmkGDateCsfStringsString10", null, null));
      }
      importView.InRmkGDateCsfStringsString10[index] = FixedStringAttr.valueOf(s, (short)10);
   }
 
   public String getInRmkGRemarkerCsfStringsString28(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return FixedStringAttr.valueOf(importView.InRmkGRemarkerCsfStringsString28[index], 28);
   }
   public void setInRmkGRemarkerCsfStringsString28(int index, String s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      if (s.length() > 28) {
         throw new PropertyVetoException("InRmkGRemarkerCsfStringsString28 must be <= 28 characters.",
               new PropertyChangeEvent (this, "InRmkGRemarkerCsfStringsString28", null, null));
      }
      importView.InRmkGRemarkerCsfStringsString28[index] = FixedStringAttr.valueOf(s, (short)28);
   }
   ...
   public String getOutRmkTypeWsGenericCodeCode() {
      return FixedStringAttr.valueOf(exportView.OutRmkTypeWsGenericCodeCode, 10);
   }
 
   public String getOutRmkTypeWsGenericCodeEngDescription() {
      return FixedStringAttr.valueOf(exportView.OutRmkTypeWsGenericCodeEngDescription, 40);
   }
   ...
   public final int OutRemarkGroupMax = 25;
   public short getOutRemarkGroupCount() {
      return (short)(exportView.OutRemarkGroup_MA);
   };
 
   public short getOutRmkGWsUnisaCollegeCode(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return exportView.OutRmkGWsUnisaCollegeCode[index];
   }
 
   public String getOutRmkGWsUnisaCollegeAbbreviation(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return FixedStringAttr.valueOf(exportView.OutRmkGWsUnisaCollegeAbbreviation[index], 10);
   }
 
   public short getOutRmkGWsUnisaSchoolCode(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return exportView.OutRmkGWsUnisaSchoolCode[index];
   }
 
   public String getOutRmkGWsUnisaSchoolAbbreviation(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return FixedStringAttr.valueOf(exportView.OutRmkGWsUnisaSchoolAbbreviation[index], 20);
   }
 
   public short getOutRmkGWsDepartmentCode(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return exportView.OutRmkGWsDepartmentCode[index];
   }
 
   public String getOutRmkGWsDepartmentEngDescription(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return FixedStringAttr.valueOf(exportView.OutRmkGWsDepartmentEngDescription[index], 28);
   }
 
   public int getOutRmkGExamReMarkMkStudentNr(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return exportView.OutRmkGExamReMarkMkStudentNr[index];
   }
 
   public String getOutRmkGExamReMarkMkStudyUnitCode(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return FixedStringAttr.valueOf(exportView.OutRmkGExamReMarkMkStudyUnitCode[index], 7);
   }
 
   public short getOutRmkGExamReMarkPrintBatch(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return exportView.OutRmkGExamReMarkPrintBatch[index];
   }
 
   public String getOutRmkGStudentNameCsfStringsString28(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return FixedStringAttr.valueOf(exportView.OutRmkGStudentNameCsfStringsString28[index], 28);
   }
 
   public short getOutRmkGExamPaperDetailsNr(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return exportView.OutRmkGExamPaperDetailsNr[index];
   }
 
   public String getOutRmkGStatusWsGenericCodeCode(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return FixedStringAttr.valueOf(exportView.OutRmkGStatusWsGenericCodeCode[index], 10);
   }
 
   public String getOutRmkGShelfCsfStringsString7(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return FixedStringAttr.valueOf(exportView.OutRmkGShelfCsfStringsString7[index], 7);
   }
 
   public String getOutRmkGDateCsfStringsString10(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return FixedStringAttr.valueOf(exportView.OutRmkGDateCsfStringsString10[index], 10);
   }
 
   public String getOutRmkGRemarkerCsfStringsString28(int index) throws ArrayIndexOutOfBoundsException {
      if (24 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 24, not: " + index);
      }
      return FixedStringAttr.valueOf(exportView.OutRmkGRemarkerCsfStringsString28[index], 28);
   }
