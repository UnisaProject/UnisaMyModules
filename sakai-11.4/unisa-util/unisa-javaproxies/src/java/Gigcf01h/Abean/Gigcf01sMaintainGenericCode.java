 ...
 */
public class Gigcf01sMaintainGenericCode  implements ActionListener, java.io.Serializable  {
 
   //  Use final String for the bean name
   public static final String BEANNAME = new String("Gigcf01sMaintainGenericCode");
   ...
   public Gigcf01sMaintainGenericCode() {
      super();
   ...
   private Gigcf01sMaintainGenericCodeOperation oper = null;
   ...
   public void execute()  throws PropertyVetoException {
      try  {
         if (oper == null) {
            oper = new Gigcf01sMaintainGenericCodeOperation(this);
         ...
         oper.doGigcf01sMaintainGenericCodeOperation();
   ...
   private class operListener implements ActionListener, java.io.Serializable  {
      private Gigcf01sMaintainGenericCode rP;
      operListener(Gigcf01sMaintainGenericCode r)  {
         rP = r;
      }
      public void actionPerformed(ActionEvent aEvent)  {
         if (Trace.isTracing(Trace.MASK_APPLICATION))
         {
            Trace.record(Trace.MASK_APPLICATION, "Gigcf01sMaintainGenericCode", "Listener heard that Gigcf01sMaintainGenericCodeOperation completed with " + 
   ...
   private void notifyCompletionListeners()  {
      if (Trace.isTracing(Trace.MASK_APPLICATION))
      {
         Trace.record(Trace.MASK_APPLICATION, BEANNAME, "notifying listeners of completion of operation Gigcf01sMaintainGenericCode ()\n");
      }
      Vector targets;
      ...
      actionEvt = new ActionEvent(this, 0, "Completion.Gigcf01sMaintainGenericCode");
   ...
   private void notifyExceptionListeners(String s)  {
      if (Trace.isTracing(Trace.MASK_APPLICATION))
      {
         Trace.record(Trace.MASK_APPLICATION, BEANNAME, "notifying listeners of exception of operation Gigcf01sMaintainGenericCode ()\n");
      }
      Vector targets;
      ActionEvent actionEvt = null;
      String failCommand = "Exception.Gigcf01sMaintainGenericCode";
      synchronized (this)  {
   ...
   public void clear()  throws PropertyVetoException  {
      ...
      importView.reset();
      exportView.reset();
      importView.InGroupGenericCode_MA = IntAttr.valueOf(InGroupGenericCodeMax);
      exportView.OutGroupGenericCode_MA = IntAttr.getDefaultValue();
   }

   Gigcf01h.GIGCF01S_IA importView = Gigcf01h.GIGCF01S_IA.getInstance();
   Gigcf01h.GIGCF01S_OA exportView = Gigcf01h.GIGCF01S_OA.getInstance();
   public String getInCsfEventCommunicationsRgvExistingLineSelectedFlag() {
      return FixedStringAttr.valueOf(importView.InCsfEventCommunicationsRgvExistingLineSelectedFlag, 1);
   }
   public void setInCsfEventCommunicationsRgvExistingLineSelectedFlag(String s)
      throws PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      if (s.length() > 1) {
         throw new PropertyVetoException("InCsfEventCommunicationsRgvExistingLineSelectedFlag must be <= 1 characters.",
               new PropertyChangeEvent (this, "InCsfEventCommunicationsRgvExistingLineSelectedFlag", null, null));
      }
      importView.InCsfEventCommunicationsRgvExistingLineSelectedFlag = FixedStringAttr.valueOf(s, (short)1);
   }
 
   public String getInCsfEventCommunicationsRgvNewLineSelectedFlag() {
      return FixedStringAttr.valueOf(importView.InCsfEventCommunicationsRgvNewLineSelectedFlag, 1);
   }
   public void setInCsfEventCommunicationsRgvNewLineSelectedFlag(String s)
      throws PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      if (s.length() > 1) {
         throw new PropertyVetoException("InCsfEventCommunicationsRgvNewLineSelectedFlag must be <= 1 characters.",
               new PropertyChangeEvent (this, "InCsfEventCommunicationsRgvNewLineSelectedFlag", null, null));
      }
      importView.InCsfEventCommunicationsRgvNewLineSelectedFlag = FixedStringAttr.valueOf(s, (short)1);
   }
 
   public String getInGenericCodeCode() {
      return FixedStringAttr.valueOf(importView.InGenericCodeCode, 10);
   }
   public void setInGenericCodeCode(String s)
      throws PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      if (s.length() > 10) {
         throw new PropertyVetoException("InGenericCodeCode must be <= 10 characters.",
               new PropertyChangeEvent (this, "InGenericCodeCode", null, null));
      }
      importView.InGenericCodeCode = FixedStringAttr.valueOf(s, (short)10);
   }
 
   public String getInGenericCodeEngDescription() {
      return FixedStringAttr.valueOf(importView.InGenericCodeEngDescription, 40);
   }
   public void setInGenericCodeEngDescription(String s)
      throws PropertyVetoException {
      if (s.length() > 40) {
         throw new PropertyVetoException("InGenericCodeEngDescription must be <= 40 characters.",
               new PropertyChangeEvent (this, "InGenericCodeEngDescription", null, null));
      }
      importView.InGenericCodeEngDescription = FixedStringAttr.valueOf(s, (short)40);
   }
 
   public String getInGenericCodeAfrDescription() {
      return FixedStringAttr.valueOf(importView.InGenericCodeAfrDescription, 40);
   }
   public void setInGenericCodeAfrDescription(String s)
      throws PropertyVetoException {
      if (s.length() > 40) {
         throw new PropertyVetoException("InGenericCodeAfrDescription must be <= 40 characters.",
               new PropertyChangeEvent (this, "InGenericCodeAfrDescription", null, null));
      }
      importView.InGenericCodeAfrDescription = FixedStringAttr.valueOf(s, (short)40);
   }
 
   public String getInGenericCodeInUseFlag() {
      return FixedStringAttr.valueOf(importView.InGenericCodeInUseFlag, 1);
   }
   public void setInGenericCodeInUseFlag(String s)
      throws PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      if (s.length() > 1) {
         throw new PropertyVetoException("InGenericCodeInUseFlag must be <= 1 characters.",
               new PropertyChangeEvent (this, "InGenericCodeInUseFlag", null, null));
      }
      importView.InGenericCodeInUseFlag = FixedStringAttr.valueOf(s, (short)1);
   }
 
   public String getInGenericCodeInfo() {
      return FixedStringAttr.valueOf(importView.InGenericCodeInfo, 40);
   }
   public void setInGenericCodeInfo(String s)
      throws PropertyVetoException {
      if (s.length() > 40) {
         throw new PropertyVetoException("InGenericCodeInfo must be <= 40 characters.",
               new PropertyChangeEvent (this, "InGenericCodeInfo", null, null));
      }
      importView.InGenericCodeInfo = FixedStringAttr.valueOf(s, (short)40);
   }
 
   public short getInGenericCategoryCode() {
      return importView.InGenericCategoryCode;
   }
   public void setInGenericCategoryCode(short s)
      throws PropertyVetoException {
      if (java.lang.Math.abs(s) >= 1000.0) {
         throw new PropertyVetoException("InGenericCategoryCode has more than 3 digits.",
               new PropertyChangeEvent (this, "InGenericCategoryCode", null, null));
      }
      importView.InGenericCategoryCode = ShortAttr.valueOf(s);
   }
   public void setAsStringInGenericCategoryCode(String s)
      throws PropertyVetoException {
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("InGenericCategoryCode is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InGenericCategoryCode", null, null));
      }
      try {
          setInGenericCategoryCode(Short.parseShort(s) );
   ...
   public String getInGenericCategoryDescription() {
      return FixedStringAttr.valueOf(importView.InGenericCategoryDescription, 40);
   }
   public void setInGenericCategoryDescription(String s)
      throws PropertyVetoException {
      if (s.length() > 40) {
         throw new PropertyVetoException("InGenericCategoryDescription must be <= 40 characters.",
               new PropertyChangeEvent (this, "InGenericCategoryDescription", null, null));
      }
      importView.InGenericCategoryDescription = FixedStringAttr.valueOf(s, (short)40);
   }
 
   public String getInGenericCategoryInUseFlag() {
      return FixedStringAttr.valueOf(importView.InGenericCategoryInUseFlag, 1);
   }
   public void setInGenericCategoryInUseFlag(String s)
      throws PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      if (s.length() > 1) {
         throw new PropertyVetoException("InGenericCategoryInUseFlag must be <= 1 characters.",
               new PropertyChangeEvent (this, "InGenericCategoryInUseFlag", null, null));
      }
      importView.InGenericCategoryInUseFlag = FixedStringAttr.valueOf(s, (short)1);
   }
 
   public final int InGroupGenericCodeMax = 120;
   public short getInGroupGenericCodeCount() {
      return (short)(importView.InGroupGenericCode_MA);
   };
 
   public void setInGroupGenericCodeCount(short s) throws PropertyVetoException {
      if (s < 0 || s > InGroupGenericCodeMax) {
         throw new PropertyVetoException("InGroupGenericCodeCount value is not a valid value. (0 to 120)",
               new PropertyChangeEvent (this, "InGroupGenericCodeCount", null, null));
      } else {
         importView.InGroupGenericCode_MA = IntAttr.valueOf((int)s);
      }
   }
 
   public String getInGGenericCodeCode(int index) throws ArrayIndexOutOfBoundsException {
      if (119 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 119, not: " + index);
      }
      return FixedStringAttr.valueOf(importView.InGGenericCodeCode[index], 10);
   }
   public void setInGGenericCodeCode(int index, String s)
      ...
      if (s.length() > 10) {
         throw new PropertyVetoException("InGGenericCodeCode must be <= 10 characters.",
               new PropertyChangeEvent (this, "InGGenericCodeCode", null, null));
      }
      importView.InGGenericCodeCode[index] = FixedStringAttr.valueOf(s, (short)10);
   }
 
   public String getInGGenericCodeEngDescription(int index) throws ArrayIndexOutOfBoundsException {
      if (119 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 119, not: " + index);
      }
      return FixedStringAttr.valueOf(importView.InGGenericCodeEngDescription[index], 40);
   }
   public void setInGGenericCodeEngDescription(int index, String s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (119 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 119, not: " + index);
      }
      if (s.length() > 40) {
         throw new PropertyVetoException("InGGenericCodeEngDescription must be <= 40 characters.",
               new PropertyChangeEvent (this, "InGGenericCodeEngDescription", null, null));
      }
      importView.InGGenericCodeEngDescription[index] = FixedStringAttr.valueOf(s, (short)40);
   }
 
   public String getInGGenericCodeAfrDescription(int index) throws ArrayIndexOutOfBoundsException {
      if (119 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 119, not: " + index);
      }
      return FixedStringAttr.valueOf(importView.InGGenericCodeAfrDescription[index], 40);
   }
   public void setInGGenericCodeAfrDescription(int index, String s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (119 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 119, not: " + index);
      }
      if (s.length() > 40) {
         throw new PropertyVetoException("InGGenericCodeAfrDescription must be <= 40 characters.",
               new PropertyChangeEvent (this, "InGGenericCodeAfrDescription", null, null));
      }
      importView.InGGenericCodeAfrDescription[index] = FixedStringAttr.valueOf(s, (short)40);
   }
 
   public String getInGGenericCodeInUseFlag(int index) throws ArrayIndexOutOfBoundsException {
      if (119 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 119, not: " + index);
      }
      return FixedStringAttr.valueOf(importView.InGGenericCodeInUseFlag[index], 1);
   }
   public void setInGGenericCodeInUseFlag(int index, String s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      ...
      if (s.length() > 1) {
         throw new PropertyVetoException("InGGenericCodeInUseFlag must be <= 1 characters.",
               new PropertyChangeEvent (this, "InGGenericCodeInUseFlag", null, null));
      }
      importView.InGGenericCodeInUseFlag[index] = FixedStringAttr.valueOf(s, (short)1);
   }
 
   public String getInGGenericCodeInfo(int index) throws ArrayIndexOutOfBoundsException {
      if (119 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 119, not: " + index);
      }
      return FixedStringAttr.valueOf(importView.InGGenericCodeInfo[index], 40);
   }
   public void setInGGenericCodeInfo(int index, String s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (119 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 119, not: " + index);
      }
      if (s.length() > 40) {
         throw new PropertyVetoException("InGGenericCodeInfo must be <= 40 characters.",
               new PropertyChangeEvent (this, "InGGenericCodeInfo", null, null));
      }
      importView.InGGenericCodeInfo[index] = FixedStringAttr.valueOf(s, (short)40);
   }
   ...
   public int getInputWsUserNumber() {
      return importView.InputWsUserNumber;
   }
   public void setInputWsUserNumber(int s)
      throws PropertyVetoException {
      if (java.lang.Math.abs(s) >= 100000.0) {
         throw new PropertyVetoException("InputWsUserNumber has more than 5 digits.",
               new PropertyChangeEvent (this, "InputWsUserNumber", null, null));
      }
      importView.InputWsUserNumber = IntAttr.valueOf(s);
   }
   public void setAsStringInputWsUserNumber(String s)
      throws PropertyVetoException {
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("InputWsUserNumber is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InputWsUserNumber", null, null));
      }
      try {
          setInputWsUserNumber(Integer.parseInt(s) );
      } catch (NumberFormatException e) {
          throw new PropertyVetoException("InputWsUserNumber is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InputWsUserNumber", null, null));
      }
   ...
   public String getInputWsPrinterCode() {
      return FixedStringAttr.valueOf(importView.InputWsPrinterCode, 10);
   }
   public void setInputWsPrinterCode(String s)
      throws PropertyVetoException {
      if (s.length() > 10) {
         throw new PropertyVetoException("InputWsPrinterCode must be <= 10 characters.",
               new PropertyChangeEvent (this, "InputWsPrinterCode", null, null));
      }
      importView.InputWsPrinterCode = FixedStringAttr.valueOf(s, (short)10);
   }
   ...
   public String getOutCsfEventCommunicationsRgvExistingLineSelectedFlag() {
      return FixedStringAttr.valueOf(exportView.OutCsfEventCommunicationsRgvExistingLineSelectedFlag, 1);
   }
 
   public String getOutCsfEventCommunicationsRgvNewLineSelectedFlag() {
      return FixedStringAttr.valueOf(exportView.OutCsfEventCommunicationsRgvNewLineSelectedFlag, 1);
   }
 
   public String getOutGenericCodeCode() {
      return FixedStringAttr.valueOf(exportView.OutGenericCodeCode, 10);
   }
 
   public String getOutGenericCodeEngDescription() {
      return FixedStringAttr.valueOf(exportView.OutGenericCodeEngDescription, 40);
   }
 
   public String getOutGenericCodeAfrDescription() {
      return FixedStringAttr.valueOf(exportView.OutGenericCodeAfrDescription, 40);
   }
 
   public String getOutGenericCodeInUseFlag() {
      return FixedStringAttr.valueOf(exportView.OutGenericCodeInUseFlag, 1);
   }
 
   public String getOutGenericCodeInfo() {
      return FixedStringAttr.valueOf(exportView.OutGenericCodeInfo, 40);
   }
 
   public String getOutWizfuncReportingControlPath() {
      return FixedStringAttr.valueOf(exportView.OutWizfuncReportingControlPath, 42);
   }
 
   public String getOutWizfuncReportingControlFilename() {
      return FixedStringAttr.valueOf(exportView.OutWizfuncReportingControlFilename, 20);
   }
 
   public String getOutWizfuncReportingControlSupressFormFeed() {
      return FixedStringAttr.valueOf(exportView.OutWizfuncReportingControlSupressFormFeed, 1);
   }
 
   public String getOutWizfuncReportingControlPrintOptions() {
      return StringAttr.valueOf(exportView.OutWizfuncReportingControlPrintOptions);
   }
   ...
   public String getOutWizfuncReportingControlFunction() {
      return FixedStringAttr.valueOf(exportView.OutWizfuncReportingControlFunction, 8);
   }
 
   public String getOutWizfuncReportingControlPathAndFilename() {
      return StringAttr.valueOf(exportView.OutWizfuncReportingControlPathAndFilename);
   }
 
   public String getOutWizfuncReportingControlProgramName() {
      return FixedStringAttr.valueOf(exportView.OutWizfuncReportingControlProgramName, 8);
   }
 
   public short getOutWizfuncReportingControlReportWidth() {
      return exportView.OutWizfuncReportingControlReportWidth;
   }
 
   public int getOutWizfuncReportingControlStartingLineCount() {
      return exportView.OutWizfuncReportingControlStartingLineCount;
   }
 
   public int getOutWizfuncReportingControlEndingLineCount() {
      return exportView.OutWizfuncReportingControlEndingLineCount;
   }
 
   public short getOutGenericCategoryCode() {
      return exportView.OutGenericCategoryCode;
   }
 
   public String getOutGenericCategoryDescription() {
      return FixedStringAttr.valueOf(exportView.OutGenericCategoryDescription, 40);
   }
 
   public String getOutGenericCategoryInUseFlag() {
      return FixedStringAttr.valueOf(exportView.OutGenericCategoryInUseFlag, 1);
   }
 
   public final int OutGroupGenericCodeMax = 120;
   public short getOutGroupGenericCodeCount() {
      return (short)(exportView.OutGroupGenericCode_MA);
   };
 
   public String getOutGGenericCodeCode(int index) throws ArrayIndexOutOfBoundsException {
      if (119 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 119, not: " + index);
      }
      return FixedStringAttr.valueOf(exportView.OutGGenericCodeCode[index], 10);
   }
 
   public String getOutGGenericCodeEngDescription(int index) throws ArrayIndexOutOfBoundsException {
      if (119 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 119, not: " + index);
      }
      return FixedStringAttr.valueOf(exportView.OutGGenericCodeEngDescription[index], 40);
   }
 
   public String getOutGGenericCodeAfrDescription(int index) throws ArrayIndexOutOfBoundsException {
      if (119 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 119, not: " + index);
      }
      return FixedStringAttr.valueOf(exportView.OutGGenericCodeAfrDescription[index], 40);
   }
 
   public String getOutGGenericCodeInUseFlag(int index) throws ArrayIndexOutOfBoundsException {
      if (119 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 119, not: " + index);
      }
      return FixedStringAttr.valueOf(exportView.OutGGenericCodeInUseFlag[index], 1);
   }
 
   public String getOutGGenericCodeInfo(int index) throws ArrayIndexOutOfBoundsException {
      if (119 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 119, not: " + index);
      }
      return FixedStringAttr.valueOf(exportView.OutGGenericCodeInfo[index], 40);
   }
   ...
   public int getOutputWsUserNumber() {
      return exportView.OutputWsUserNumber;
   }
 
   public String getOutputWsPrinterCode() {
      return FixedStringAttr.valueOf(exportView.OutputWsPrinterCode, 10);
   }
