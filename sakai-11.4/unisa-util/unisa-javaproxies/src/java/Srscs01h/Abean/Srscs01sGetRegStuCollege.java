 ...
 */
public class Srscs01sGetRegStuCollege  implements ActionListener, java.io.Serializable  {
 
   //  Use final String for the bean name
   public static final String BEANNAME = new String("Srscs01sGetRegStuCollege");
   ...
   public Srscs01sGetRegStuCollege() {
      super();
   ...
   private Srscs01sGetRegStuCollegeOperation oper = null;
   ...
   public void execute()  throws PropertyVetoException {
      try  {
         if (oper == null) {
            oper = new Srscs01sGetRegStuCollegeOperation(this);
         ...
         oper.doSrscs01sGetRegStuCollegeOperation();
   ...
   private class operListener implements ActionListener, java.io.Serializable  {
      private Srscs01sGetRegStuCollege rP;
      operListener(Srscs01sGetRegStuCollege r)  {
         rP = r;
      }
      public void actionPerformed(ActionEvent aEvent)  {
         if (Trace.isTracing(Trace.MASK_APPLICATION))
         {
            Trace.record(Trace.MASK_APPLICATION, "Srscs01sGetRegStuCollege", "Listener heard that Srscs01sGetRegStuCollegeOperation completed with " + 
   ...
   private void notifyCompletionListeners()  {
      if (Trace.isTracing(Trace.MASK_APPLICATION))
      {
         Trace.record(Trace.MASK_APPLICATION, BEANNAME, "notifying listeners of completion of operation Srscs01sGetRegStuCollege ()\n");
      }
      Vector targets;
      ...
      actionEvt = new ActionEvent(this, 0, "Completion.Srscs01sGetRegStuCollege");
   ...
   private void notifyExceptionListeners(String s)  {
      if (Trace.isTracing(Trace.MASK_APPLICATION))
      {
         Trace.record(Trace.MASK_APPLICATION, BEANNAME, "notifying listeners of exception of operation Srscs01sGetRegStuCollege ()\n");
      }
      Vector targets;
      ActionEvent actionEvt = null;
      String failCommand = "Exception.Srscs01sGetRegStuCollege";
      synchronized (this)  {
   ...
   Srscs01h.SRSCS01S_IA importView = Srscs01h.SRSCS01S_IA.getInstance();
   Srscs01h.SRSCS01S_OA exportView = Srscs01h.SRSCS01S_OA.getInstance();
   ...
   public short getOutWsQualificationCollegeCode() {
      return exportView.OutWsQualificationCollegeCode;
   }
