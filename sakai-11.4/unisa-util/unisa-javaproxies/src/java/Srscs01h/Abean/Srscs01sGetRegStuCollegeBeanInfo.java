...
public class Srscs01sGetRegStuCollegeBeanInfo extends SimpleBeanInfo {
 
   private final static Class rootClass = Srscs01sGetRegStuCollege.class;
 ...
 //  PropertyDescriptor new can raise an IntrospectionException.
   ...
   public BeanDescriptor getBeanDescriptor() {
      BeanDescriptor bd = 
         new BeanDescriptor(Srscs01sGetRegStuCollege.class);
      bd.setDisplayName(Srscs01sGetRegStuCollege.BEANNAME);
      return bd;
   }
   ...
   public PropertyDescriptor [] getPropertyDescriptors() {
      try {
         ...
         myProperties[14] = new PropertyDescriptor("InWsStudentNr", rootClass);
         myProperties[15] = new PropertyDescriptor("OutWsMethodResultReturnCode", rootClass, "getOutWsMethodResultReturnCode", null);
         myProperties[16] = new PropertyDescriptor("OutWsQualificationUnderPostCategory", rootClass, "getOutWsQualificationUnderPostCategory", null);
         myProperties[17] = new PropertyDescriptor("OutWsQualificationCollegeCode", rootClass, "getOutWsQualificationCollegeCode", null);
         return myProperties;
...
// 
//      try {
//         callMethod = Srscs01sGetRegStuCollege.class.getMethod("execute", args);
//      } catch (Exception ex) {
//               // "should never happen"
