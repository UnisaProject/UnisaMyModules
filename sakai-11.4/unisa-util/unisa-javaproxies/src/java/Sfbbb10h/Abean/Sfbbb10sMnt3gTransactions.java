 ...
 */
public class Sfbbb10sMnt3gTransactions  implements ActionListener, java.io.Serializable  {
 
   //  Use final String for the bean name
   public static final String BEANNAME = new String("Sfbbb10sMnt3gTransactions");
   ...
   public Sfbbb10sMnt3gTransactions() {
      super();
   ...
   private Sfbbb10sMnt3gTransactionsOperation oper = null;
   ...
   public void execute()  throws PropertyVetoException {
      try  {
         if (oper == null) {
            oper = new Sfbbb10sMnt3gTransactionsOperation(this);
         ...
         oper.doSfbbb10sMnt3gTransactionsOperation();
   ...
   private class operListener implements ActionListener, java.io.Serializable  {
      private Sfbbb10sMnt3gTransactions rP;
      operListener(Sfbbb10sMnt3gTransactions r)  {
         rP = r;
      }
      public void actionPerformed(ActionEvent aEvent)  {
         if (Trace.isTracing(Trace.MASK_APPLICATION))
         {
            Trace.record(Trace.MASK_APPLICATION, "Sfbbb10sMnt3gTransactions", "Listener heard that Sfbbb10sMnt3gTransactionsOperation completed with " + 
   ...
   private void notifyCompletionListeners()  {
      if (Trace.isTracing(Trace.MASK_APPLICATION))
      {
         Trace.record(Trace.MASK_APPLICATION, BEANNAME, "notifying listeners of completion of operation Sfbbb10sMnt3gTransactions ()\n");
      }
      Vector targets;
      ...
      actionEvt = new ActionEvent(this, 0, "Completion.Sfbbb10sMnt3gTransactions");
   ...
   private void notifyExceptionListeners(String s)  {
      if (Trace.isTracing(Trace.MASK_APPLICATION))
      {
         Trace.record(Trace.MASK_APPLICATION, BEANNAME, "notifying listeners of exception of operation Sfbbb10sMnt3gTransactions ()\n");
      }
      Vector targets;
      ActionEvent actionEvt = null;
      String failCommand = "Exception.Sfbbb10sMnt3gTransactions";
      synchronized (this)  {
   ...
   Sfbbb10h.SFBBB10S_IA importView = Sfbbb10h.SFBBB10S_IA.getInstance();
   Sfbbb10h.SFBBB10S_OA exportView = Sfbbb10h.SFBBB10S_OA.getInstance();
   public short getInStudent3gMkAcademicYear() {
      return importView.InStudent3gMkAcademicYear;
   }
   public void setInStudent3gMkAcademicYear(short s)
      throws PropertyVetoException {
      if (java.lang.Math.abs(s) >= 10000.0) {
         throw new PropertyVetoException("InStudent3gMkAcademicYear has more than 4 digits.",
               new PropertyChangeEvent (this, "InStudent3gMkAcademicYear", null, null));
      }
      importView.InStudent3gMkAcademicYear = ShortAttr.valueOf(s);
   }
   public void setAsStringInStudent3gMkAcademicYear(String s)
      throws PropertyVetoException {
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("InStudent3gMkAcademicYear is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InStudent3gMkAcademicYear", null, null));
      }
      try {
          setInStudent3gMkAcademicYear(Short.parseShort(s) );
   ...
   public short getInStudent3gCalendarPeriod() {
      return importView.InStudent3gCalendarPeriod;
   }
   public void setInStudent3gCalendarPeriod(short s)
      throws PropertyVetoException {
      if (java.lang.Math.abs(s) >= 1000.0) {
         throw new PropertyVetoException("InStudent3gCalendarPeriod has more than 3 digits.",
               new PropertyChangeEvent (this, "InStudent3gCalendarPeriod", null, null));
      }
      importView.InStudent3gCalendarPeriod = ShortAttr.valueOf(s);
   }
   public void setAsStringInStudent3gCalendarPeriod(String s)
      throws PropertyVetoException {
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("InStudent3gCalendarPeriod is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InStudent3gCalendarPeriod", null, null));
      }
      try {
          setInStudent3gCalendarPeriod(Short.parseShort(s) );
      } catch (NumberFormatException e) {
          throw new PropertyVetoException("InStudent3gCalendarPeriod is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InStudent3gCalendarPeriod", null, null));
      }
   ...
   public int getInStudent3gMkStudentNr() {
      return importView.InStudent3gMkStudentNr;
   }
   public void setInStudent3gMkStudentNr(int s)
      throws PropertyVetoException {
      if (java.lang.Math.abs(s) >= 100000000.0) {
         throw new PropertyVetoException("InStudent3gMkStudentNr has more than 8 digits.",
               new PropertyChangeEvent (this, "InStudent3gMkStudentNr", null, null));
      }
      importView.InStudent3gMkStudentNr = IntAttr.valueOf(s);
   }
   public void setAsStringInStudent3gMkStudentNr(String s)
      throws PropertyVetoException {
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("InStudent3gMkStudentNr is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InStudent3gMkStudentNr", null, null));
      }
      try {
          setInStudent3gMkStudentNr(Integer.parseInt(s) );
      } catch (NumberFormatException e) {
          throw new PropertyVetoException("InStudent3gMkStudentNr is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InStudent3gMkStudentNr", null, null));
      }
   ...
   public String getInActionCsfStringsString3() {
      return FixedStringAttr.valueOf(importView.InActionCsfStringsString3, 3);
   }
   public void setInActionCsfStringsString3(String s)
      throws PropertyVetoException {
      if (s.length() > 3) {
         throw new PropertyVetoException("InActionCsfStringsString3 must be <= 3 characters.",
               new PropertyChangeEvent (this, "InActionCsfStringsString3", null, null));
      }
      importView.InActionCsfStringsString3 = FixedStringAttr.valueOf(s, (short)3);
   }
   ...
   public double getOutAvailableBalanceStudentAccountBalance() {
      return exportView.OutAvailableBalanceStudentAccountBalance;
   }
 
   public String getOutPaymentReferenceCsfStringsString17() {
      return FixedStringAttr.valueOf(exportView.OutPaymentReferenceCsfStringsString17, 17);
   }
