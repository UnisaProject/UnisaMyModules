 ...
 */
public class Srsms01sSendSingleSms  implements ActionListener, java.io.Serializable  {
 
   //  Use final String for the bean name
   public static final String BEANNAME = new String("Srsms01sSendSingleSms");
   ...
   private Srsms01sSendSingleSmsOperation oper = null;
   ...
   public void execute()  throws PropertyVetoException {
      try  {
         if (oper == null) {
            oper = new Srsms01sSendSingleSmsOperation(this);
         ...
         oper.doSrsms01sSendSingleSmsOperation();
   ...
   private class operListener implements ActionListener, java.io.Serializable  {
      private Srsms01sSendSingleSms rP;
      operListener(Srsms01sSendSingleSms r)  {
         rP = r;
      }
      public void actionPerformed(ActionEvent aEvent)  {
         if (Trace.isTracing(Trace.MASK_APPLICATION))
         {
            Trace.record(Trace.MASK_APPLICATION, "Srsms01sSendSingleSms", "Listener heard that Srsms01sSendSingleSmsOperation completed with " + 
   ...
   private void notifyCompletionListeners()  {
      if (Trace.isTracing(Trace.MASK_APPLICATION))
      {
         Trace.record(Trace.MASK_APPLICATION, BEANNAME, "notifying listeners of completion of operation Srsms01sSendSingleSms ()\n");
      }
      Vector targets;
      ...
      actionEvt = new ActionEvent(this, 0, "Completion.Srsms01sSendSingleSms");
   ...
   private void notifyExceptionListeners(String s)  {
      if (Trace.isTracing(Trace.MASK_APPLICATION))
      {
         Trace.record(Trace.MASK_APPLICATION, BEANNAME, "notifying listeners of exception of operation Srsms01sSendSingleSms ()\n");
      }
      Vector targets;
      ActionEvent actionEvt = null;
      String failCommand = "Exception.Srsms01sSendSingleSms";
      synchronized (this)  {
   ...
   Srsms01h.SRSMS01S_IA importView = Srsms01h.SRSMS01S_IA.getInstance();
   Srsms01h.SRSMS01S_OA exportView = Srsms01h.SRSMS01S_OA.getInstance();
   ...
   public int getInSmsQueueMkBatchNr() {
      return importView.InSmsQueueMkBatchNr;
   }
   public void setInSmsQueueMkBatchNr(int s)
      throws PropertyVetoException {
      if (java.lang.Math.abs(s) >= 10000000.0) {
         throw new PropertyVetoException("InSmsQueueMkBatchNr has more than 7 digits.",
               new PropertyChangeEvent (this, "InSmsQueueMkBatchNr", null, null));
      }
      importView.InSmsQueueMkBatchNr = IntAttr.valueOf(s);
   }
   public void setAsStringInSmsQueueMkBatchNr(String s)
      throws PropertyVetoException {
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("InSmsQueueMkBatchNr is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InSmsQueueMkBatchNr", null, null));
      }
      try {
          setInSmsQueueMkBatchNr(Integer.parseInt(s) );
      } catch (NumberFormatException e) {
          throw new PropertyVetoException("InSmsQueueMkBatchNr is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InSmsQueueMkBatchNr", null, null));
      }
   ...
   public int getInSmsQueueSequenceNr() {
      return importView.InSmsQueueSequenceNr;
   }
   public void setInSmsQueueSequenceNr(int s)
      throws PropertyVetoException {
      if (java.lang.Math.abs(s) >= 1000000.0) {
         throw new PropertyVetoException("InSmsQueueSequenceNr has more than 6 digits.",
               new PropertyChangeEvent (this, "InSmsQueueSequenceNr", null, null));
      }
      importView.InSmsQueueSequenceNr = IntAttr.valueOf(s);
   }
   public void setAsStringInSmsQueueSequenceNr(String s)
      throws PropertyVetoException {
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("InSmsQueueSequenceNr is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InSmsQueueSequenceNr", null, null));
      }
      try {
          setInSmsQueueSequenceNr(Integer.parseInt(s) );
      } catch (NumberFormatException e) {
          throw new PropertyVetoException("InSmsQueueSequenceNr is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InSmsQueueSequenceNr", null, null));
      }
   ...
   public int getInSmsQueueReferenceNr() {
      return importView.InSmsQueueReferenceNr;
   }
   public void setInSmsQueueReferenceNr(int s)
      throws PropertyVetoException {
      if (java.lang.Math.abs(s) >= 100000000.0) {
         throw new PropertyVetoException("InSmsQueueReferenceNr has more than 8 digits.",
               new PropertyChangeEvent (this, "InSmsQueueReferenceNr", null, null));
      }
      importView.InSmsQueueReferenceNr = IntAttr.valueOf(s);
   }
   public void setAsStringInSmsQueueReferenceNr(String s)
      throws PropertyVetoException {
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("InSmsQueueReferenceNr is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InSmsQueueReferenceNr", null, null));
      }
      try {
          setInSmsQueueReferenceNr(Integer.parseInt(s) );
      } catch (NumberFormatException e) {
          throw new PropertyVetoException("InSmsQueueReferenceNr is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InSmsQueueReferenceNr", null, null));
      }
   ...
   public String getInSmsQueueCellNr() {
      return StringAttr.valueOf(importView.InSmsQueueCellNr);
   }
   public void setInSmsQueueCellNr(String s)
      throws PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      if (s.length() > 20) {
         throw new PropertyVetoException("InSmsQueueCellNr must be <= 20 characters.",
               new PropertyChangeEvent (this, "InSmsQueueCellNr", null, null));
      }
      importView.InSmsQueueCellNr = StringAttr.valueOf(s, (short)20);
   }
 
   public String getInSmsQueueMessage() {
      return StringAttr.valueOf(importView.InSmsQueueMessage);
   }
   public void setInSmsQueueMessage(String s)
      throws PropertyVetoException {
      if (s.length() > 160) {
         throw new PropertyVetoException("InSmsQueueMessage must be <= 160 characters.",
               new PropertyChangeEvent (this, "InSmsQueueMessage", null, null));
      }
      importView.InSmsQueueMessage = StringAttr.valueOf(s, (short)160);
   }
   ...
   public String getInWsSmsToSmsTo() {
      return StringAttr.valueOf(importView.InWsSmsToSmsTo);
   }
   public void setInWsSmsToSmsTo(String s)
      throws PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      Srsms01sSendSingleSmsWsSmsToSmsToPropertyEditor pe = new Srsms01sSendSingleSmsWsSmsToSmsToPropertyEditor();
      if (pe.checkTag(s) == false) {
         throw new PropertyVetoException("InWsSmsToSmsTo value  \"" + s + "\"  is not a permitted value.",
               new PropertyChangeEvent (this, "InWsSmsToSmsTo", null, null));
      }
      if (s.length() > 1) {
         throw new PropertyVetoException("InWsSmsToSmsTo must be <= 1 characters.",
               new PropertyChangeEvent (this, "InWsSmsToSmsTo", null, null));
      }
      importView.InWsSmsToSmsTo = StringAttr.valueOf(s, (short)1);
   }
   ...
   public int getOutSmsQueueMkBatchNr() {
      return exportView.OutSmsQueueMkBatchNr;
   }
 
   public int getOutSmsQueueSequenceNr() {
      return exportView.OutSmsQueueSequenceNr;
   }
 
   public int getOutSmsQueueReferenceNr() {
      return exportView.OutSmsQueueReferenceNr;
   }
 
   public String getOutSmsQueueCellNr() {
      return StringAttr.valueOf(exportView.OutSmsQueueCellNr);
   }
 
   public String getOutSmsQueueMessage() {
      return StringAttr.valueOf(exportView.OutSmsQueueMessage);
   }
   ...
   public String getOutWsSmsToSmsTo() {
      return StringAttr.valueOf(exportView.OutWsSmsToSmsTo);
   }
