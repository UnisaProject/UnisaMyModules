 ...
 */
public class Expsh01sExamScriptOutstanding  implements ActionListener, java.io.Serializable  {
 
   //  Use final String for the bean name
   public static final String BEANNAME = new String("Expsh01sExamScriptOutstanding");
   ...
   public Expsh01sExamScriptOutstanding() {
      super();
   ...
   private Expsh01sExamScriptOutstandingOperation oper = null;
   ...
   public void execute()  throws PropertyVetoException {
      try  {
         if (oper == null) {
            oper = new Expsh01sExamScriptOutstandingOperation(this);
         ...
         oper.doExpsh01sExamScriptOutstandingOperation();
   ...
   private class operListener implements ActionListener, java.io.Serializable  {
      private Expsh01sExamScriptOutstanding rP;
      operListener(Expsh01sExamScriptOutstanding r)  {
         rP = r;
      }
      public void actionPerformed(ActionEvent aEvent)  {
         if (Trace.isTracing(Trace.MASK_APPLICATION))
         {
            Trace.record(Trace.MASK_APPLICATION, "Expsh01sExamScriptOutstanding", "Listener heard that Expsh01sExamScriptOutstandingOperation completed with " + 
   ...
   private void notifyCompletionListeners()  {
      if (Trace.isTracing(Trace.MASK_APPLICATION))
      {
         Trace.record(Trace.MASK_APPLICATION, BEANNAME, "notifying listeners of completion of operation Expsh01sExamScriptOutstanding ()\n");
      }
      Vector targets;
      ...
      actionEvt = new ActionEvent(this, 0, "Completion.Expsh01sExamScriptOutstanding");
   ...
   private void notifyExceptionListeners(String s)  {
      if (Trace.isTracing(Trace.MASK_APPLICATION))
      {
         Trace.record(Trace.MASK_APPLICATION, BEANNAME, "notifying listeners of exception of operation Expsh01sExamScriptOutstanding ()\n");
      }
      Vector targets;
      ActionEvent actionEvt = null;
      String failCommand = "Exception.Expsh01sExamScriptOutstanding";
      synchronized (this)  {
   ...
   Expsh01h.EXPSH01S_IA importView = Expsh01h.EXPSH01S_IA.getInstance();
   Expsh01h.EXPSH01S_OA exportView = Expsh01h.EXPSH01S_OA.getInstance();
   public int getInLowStudentExamResultMkStudentNr() {
      return importView.InLowStudentExamResultMkStudentNr;
   }
   public void setInLowStudentExamResultMkStudentNr(int s)
      throws PropertyVetoException {
      if (java.lang.Math.abs(s) >= 100000000.0) {
         throw new PropertyVetoException("InLowStudentExamResultMkStudentNr has more than 8 digits.",
               new PropertyChangeEvent (this, "InLowStudentExamResultMkStudentNr", null, null));
      }
      importView.InLowStudentExamResultMkStudentNr = IntAttr.valueOf(s);
   }
   public void setAsStringInLowStudentExamResultMkStudentNr(String s)
      throws PropertyVetoException {
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("InLowStudentExamResultMkStudentNr is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InLowStudentExamResultMkStudentNr", null, null));
      }
      try {
          setInLowStudentExamResultMkStudentNr(Integer.parseInt(s) );
   ...
   public int getInHighStudentExamResultMkStudentNr() {
      return importView.InHighStudentExamResultMkStudentNr;
   }
   public void setInHighStudentExamResultMkStudentNr(int s)
      throws PropertyVetoException {
      if (java.lang.Math.abs(s) >= 100000000.0) {
         throw new PropertyVetoException("InHighStudentExamResultMkStudentNr has more than 8 digits.",
               new PropertyChangeEvent (this, "InHighStudentExamResultMkStudentNr", null, null));
      }
      importView.InHighStudentExamResultMkStudentNr = IntAttr.valueOf(s);
   }
   public void setAsStringInHighStudentExamResultMkStudentNr(String s)
      throws PropertyVetoException {
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("InHighStudentExamResultMkStudentNr is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InHighStudentExamResultMkStudentNr", null, null));
      }
      try {
          setInHighStudentExamResultMkStudentNr(Integer.parseInt(s) );
      } catch (NumberFormatException e) {
          throw new PropertyVetoException("InHighStudentExamResultMkStudentNr is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InHighStudentExamResultMkStudentNr", null, null));
      }
   ...
   public int getInStartingStudentExamResultMkStudentNr() {
      return importView.InStartingStudentExamResultMkStudentNr;
   }
   public void setInStartingStudentExamResultMkStudentNr(int s)
      throws PropertyVetoException {
      if (java.lang.Math.abs(s) >= 100000000.0) {
         throw new PropertyVetoException("InStartingStudentExamResultMkStudentNr has more than 8 digits.",
               new PropertyChangeEvent (this, "InStartingStudentExamResultMkStudentNr", null, null));
      }
      importView.InStartingStudentExamResultMkStudentNr = IntAttr.valueOf(s);
   }
   public void setAsStringInStartingStudentExamResultMkStudentNr(String s)
      throws PropertyVetoException {
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("InStartingStudentExamResultMkStudentNr is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InStartingStudentExamResultMkStudentNr", null, null));
      }
      try {
          setInStartingStudentExamResultMkStudentNr(Integer.parseInt(s) );
      } catch (NumberFormatException e) {
          throw new PropertyVetoException("InStartingStudentExamResultMkStudentNr is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InStartingStudentExamResultMkStudentNr", null, null));
      }
   ...
   public String getInWsExamVenueEngName() {
      return FixedStringAttr.valueOf(importView.InWsExamVenueEngName, 28);
   }
   public void setInWsExamVenueEngName(String s)
      throws PropertyVetoException {
      if (s.length() > 28) {
         throw new PropertyVetoException("InWsExamVenueEngName must be <= 28 characters.",
               new PropertyChangeEvent (this, "InWsExamVenueEngName", null, null));
      }
      importView.InWsExamVenueEngName = FixedStringAttr.valueOf(s, (short)28);
   }
   ...
   public short getOutStartingExamPaperVenueStatisticsExamYear() {
      return exportView.OutStartingExamPaperVenueStatisticsExamYear;
   }
 
   public String getOutStartingExamPaperVenueStatisticsMkStudyUnitCode() {
      return FixedStringAttr.valueOf(exportView.OutStartingExamPaperVenueStatisticsMkStudyUnitCode, 7);
   }
 
   public short getOutStartingExamPaperVenueStatisticsMkExamPeriodCode() {
      return exportView.OutStartingExamPaperVenueStatisticsMkExamPeriodCode;
   }
 
   public String getOutStartingExamPaperVenueStatisticsMkExamVenueCode() {
      return FixedStringAttr.valueOf(exportView.OutStartingExamPaperVenueStatisticsMkExamVenueCode, 7);
   }
 
   public short getOutStartingExamPaperVenueStatisticsNr() {
      return exportView.OutStartingExamPaperVenueStatisticsNr;
   }
   ...
   public String getOutGNameCsfStringsString50(int index) throws ArrayIndexOutOfBoundsException {
      if (99 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 99, not: " + index);
      }
      return FixedStringAttr.valueOf(exportView.OutGNameCsfStringsString50[index], 50);
   }
 
   public String getOutGCommentCsfStringsString40(int index) throws ArrayIndexOutOfBoundsException {
      if (99 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 99, not: " + index);
      }
      return FixedStringAttr.valueOf(exportView.OutGCommentCsfStringsString40[index], 40);
   }
 
   public String getOutGOutstandingCsfStringsString30(int index) throws ArrayIndexOutOfBoundsException {
      if (99 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 99, not: " + index);
      }
      return FixedStringAttr.valueOf(exportView.OutGOutstandingCsfStringsString30[index], 30);
   }
