 ...
 */
public class Expsc10sLstExamPaperVenueSt  implements ActionListener, java.io.Serializable  {
 
   //  Use final String for the bean name
   public static final String BEANNAME = new String("Expsc10sLstExamPaperVenueSt");
   ...
   public Expsc10sLstExamPaperVenueSt() {
      super();
   ...
   private Expsc10sLstExamPaperVenueStOperation oper = null;
   ...
   public void execute()  throws PropertyVetoException {
      try  {
         if (oper == null) {
            oper = new Expsc10sLstExamPaperVenueStOperation(this);
         ...
         oper.doExpsc10sLstExamPaperVenueStOperation();
   ...
   private class operListener implements ActionListener, java.io.Serializable  {
      private Expsc10sLstExamPaperVenueSt rP;
      operListener(Expsc10sLstExamPaperVenueSt r)  {
         rP = r;
      }
      public void actionPerformed(ActionEvent aEvent)  {
         if (Trace.isTracing(Trace.MASK_APPLICATION))
         {
            Trace.record(Trace.MASK_APPLICATION, "Expsc10sLstExamPaperVenueSt", "Listener heard that Expsc10sLstExamPaperVenueStOperation completed with " + 
   ...
   private void notifyCompletionListeners()  {
      if (Trace.isTracing(Trace.MASK_APPLICATION))
      {
         Trace.record(Trace.MASK_APPLICATION, BEANNAME, "notifying listeners of completion of operation Expsc10sLstExamPaperVenueSt ()\n");
      }
      Vector targets;
      ...
      actionEvt = new ActionEvent(this, 0, "Completion.Expsc10sLstExamPaperVenueSt");
   ...
   private void notifyExceptionListeners(String s)  {
      if (Trace.isTracing(Trace.MASK_APPLICATION))
      {
         Trace.record(Trace.MASK_APPLICATION, BEANNAME, "notifying listeners of exception of operation Expsc10sLstExamPaperVenueSt ()\n");
      }
      Vector targets;
      ActionEvent actionEvt = null;
      String failCommand = "Exception.Expsc10sLstExamPaperVenueSt";
      synchronized (this)  {
   ...
   public void clear()  throws PropertyVetoException  {
      ...
      for( int index = 0; index < 50; index++)
         exportView.OutGExamPaperVenueStatisticsStatusCode[index] = FixedStringAttr.valueOf("O", 1);
   }

   Expsc10h.EXPSC10S_IA importView = Expsc10h.EXPSC10S_IA.getInstance();
   Expsc10h.EXPSC10S_OA exportView = Expsc10h.EXPSC10S_OA.getInstance();
   public String getIn10RedCsfStringsString40() {
      return FixedStringAttr.valueOf(importView.In10RedCsfStringsString40, 40);
   }
   public void setIn10RedCsfStringsString40(String s)
      throws PropertyVetoException {
      if (s.length() > 40) {
         throw new PropertyVetoException("In10RedCsfStringsString40 must be <= 40 characters.",
               new PropertyChangeEvent (this, "In10RedCsfStringsString40", null, null));
      }
      importView.In10RedCsfStringsString40 = FixedStringAttr.valueOf(s, (short)40);
   }
 
   public short getInStartingExamPaperVenueStatisticsExamYear() {
      return importView.InStartingExamPaperVenueStatisticsExamYear;
   }
   public void setInStartingExamPaperVenueStatisticsExamYear(short s)
      throws PropertyVetoException {
      if (java.lang.Math.abs(s) >= 10000.0) {
         throw new PropertyVetoException("InStartingExamPaperVenueStatisticsExamYear has more than 4 digits.",
               new PropertyChangeEvent (this, "InStartingExamPaperVenueStatisticsExamYear", null, null));
      }
      importView.InStartingExamPaperVenueStatisticsExamYear = ShortAttr.valueOf(s);
   }
   public void setAsStringInStartingExamPaperVenueStatisticsExamYear(String s)
      throws PropertyVetoException {
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("InStartingExamPaperVenueStatisticsExamYear is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InStartingExamPaperVenueStatisticsExamYear", null, null));
      }
      try {
          setInStartingExamPaperVenueStatisticsExamYear(Short.parseShort(s) );
   ...
   public short getInStartingExamPaperVenueStatisticsMkExamPeriodCode() {
      return importView.InStartingExamPaperVenueStatisticsMkExamPeriodCode;
   }
   public void setInStartingExamPaperVenueStatisticsMkExamPeriodCode(short s)
      throws PropertyVetoException {
      if (java.lang.Math.abs(s) >= 100.0) {
         throw new PropertyVetoException("InStartingExamPaperVenueStatisticsMkExamPeriodCode has more than 2 digits.",
               new PropertyChangeEvent (this, "InStartingExamPaperVenueStatisticsMkExamPeriodCode", null, null));
      }
      importView.InStartingExamPaperVenueStatisticsMkExamPeriodCode = ShortAttr.valueOf(s);
   }
   public void setAsStringInStartingExamPaperVenueStatisticsMkExamPeriodCode(String s)
      throws PropertyVetoException {
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("InStartingExamPaperVenueStatisticsMkExamPeriodCode is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InStartingExamPaperVenueStatisticsMkExamPeriodCode", null, null));
      }
      try {
          setInStartingExamPaperVenueStatisticsMkExamPeriodCode(Short.parseShort(s) );
      } catch (NumberFormatException e) {
          throw new PropertyVetoException("InStartingExamPaperVenueStatisticsMkExamPeriodCode is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InStartingExamPaperVenueStatisticsMkExamPeriodCode", null, null));
      }
   ...
   public String getInStartingExamPaperVenueStatisticsMkStudyUnitCode() {
      return FixedStringAttr.valueOf(importView.InStartingExamPaperVenueStatisticsMkStudyUnitCode, 7);
   }
   public void setInStartingExamPaperVenueStatisticsMkStudyUnitCode(String s)
      throws PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      if (s.length() > 7) {
         throw new PropertyVetoException("InStartingExamPaperVenueStatisticsMkStudyUnitCode must be <= 7 characters.",
               new PropertyChangeEvent (this, "InStartingExamPaperVenueStatisticsMkStudyUnitCode", null, null));
      }
      importView.InStartingExamPaperVenueStatisticsMkStudyUnitCode = FixedStringAttr.valueOf(s, (short)7);
   }
 
   public String getInStartingExamPaperVenueStatisticsMkExamVenueCode() {
      return FixedStringAttr.valueOf(importView.InStartingExamPaperVenueStatisticsMkExamVenueCode, 7);
   }
   public void setInStartingExamPaperVenueStatisticsMkExamVenueCode(String s)
      throws PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      if (s.length() > 7) {
         throw new PropertyVetoException("InStartingExamPaperVenueStatisticsMkExamVenueCode must be <= 7 characters.",
               new PropertyChangeEvent (this, "InStartingExamPaperVenueStatisticsMkExamVenueCode", null, null));
      }
      importView.InStartingExamPaperVenueStatisticsMkExamVenueCode = FixedStringAttr.valueOf(s, (short)7);
   }
 
   public short getInStartingExamPaperVenueStatisticsNr() {
      return importView.InStartingExamPaperVenueStatisticsNr;
   }
   public void setInStartingExamPaperVenueStatisticsNr(short s)
      throws PropertyVetoException {
      if (java.lang.Math.abs(s) >= 10.0) {
         throw new PropertyVetoException("InStartingExamPaperVenueStatisticsNr has more than 1 digits.",
               new PropertyChangeEvent (this, "InStartingExamPaperVenueStatisticsNr", null, null));
      }
      importView.InStartingExamPaperVenueStatisticsNr = ShortAttr.valueOf(s);
   }
   public void setAsStringInStartingExamPaperVenueStatisticsNr(String s)
      throws PropertyVetoException {
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("InStartingExamPaperVenueStatisticsNr is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InStartingExamPaperVenueStatisticsNr", null, null));
      }
      try {
          setInStartingExamPaperVenueStatisticsNr(Short.parseShort(s) );
      } catch (NumberFormatException e) {
          throw new PropertyVetoException("InStartingExamPaperVenueStatisticsNr is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InStartingExamPaperVenueStatisticsNr", null, null));
      }
   ...
   public short getOnHighExamPaperVenueStatisticsExamYear() {
      return importView.OnHighExamPaperVenueStatisticsExamYear;
   }
   public void setOnHighExamPaperVenueStatisticsExamYear(short s)
      throws PropertyVetoException {
      if (java.lang.Math.abs(s) >= 10000.0) {
         throw new PropertyVetoException("OnHighExamPaperVenueStatisticsExamYear has more than 4 digits.",
               new PropertyChangeEvent (this, "OnHighExamPaperVenueStatisticsExamYear", null, null));
      }
      importView.OnHighExamPaperVenueStatisticsExamYear = ShortAttr.valueOf(s);
   }
   public void setAsStringOnHighExamPaperVenueStatisticsExamYear(String s)
      throws PropertyVetoException {
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("OnHighExamPaperVenueStatisticsExamYear is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "OnHighExamPaperVenueStatisticsExamYear", null, null));
      }
      try {
          setOnHighExamPaperVenueStatisticsExamYear(Short.parseShort(s) );
      } catch (NumberFormatException e) {
          throw new PropertyVetoException("OnHighExamPaperVenueStatisticsExamYear is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "OnHighExamPaperVenueStatisticsExamYear", null, null));
      }
   ...
   public short getOnHighExamPaperVenueStatisticsMkExamPeriodCode() {
      return importView.OnHighExamPaperVenueStatisticsMkExamPeriodCode;
   }
   public void setOnHighExamPaperVenueStatisticsMkExamPeriodCode(short s)
      throws PropertyVetoException {
      if (java.lang.Math.abs(s) >= 100.0) {
         throw new PropertyVetoException("OnHighExamPaperVenueStatisticsMkExamPeriodCode has more than 2 digits.",
               new PropertyChangeEvent (this, "OnHighExamPaperVenueStatisticsMkExamPeriodCode", null, null));
      }
      importView.OnHighExamPaperVenueStatisticsMkExamPeriodCode = ShortAttr.valueOf(s);
   }
   public void setAsStringOnHighExamPaperVenueStatisticsMkExamPeriodCode(String s)
      throws PropertyVetoException {
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("OnHighExamPaperVenueStatisticsMkExamPeriodCode is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "OnHighExamPaperVenueStatisticsMkExamPeriodCode", null, null));
      }
      try {
          setOnHighExamPaperVenueStatisticsMkExamPeriodCode(Short.parseShort(s) );
      } catch (NumberFormatException e) {
          throw new PropertyVetoException("OnHighExamPaperVenueStatisticsMkExamPeriodCode is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "OnHighExamPaperVenueStatisticsMkExamPeriodCode", null, null));
      }
   ...
   public String getOnHighExamPaperVenueStatisticsMkStudyUnitCode() {
      return FixedStringAttr.valueOf(importView.OnHighExamPaperVenueStatisticsMkStudyUnitCode, 7);
   }
   public void setOnHighExamPaperVenueStatisticsMkStudyUnitCode(String s)
      throws PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      if (s.length() > 7) {
         throw new PropertyVetoException("OnHighExamPaperVenueStatisticsMkStudyUnitCode must be <= 7 characters.",
               new PropertyChangeEvent (this, "OnHighExamPaperVenueStatisticsMkStudyUnitCode", null, null));
      }
      importView.OnHighExamPaperVenueStatisticsMkStudyUnitCode = FixedStringAttr.valueOf(s, (short)7);
   }
 
   public String getOnHighExamPaperVenueStatisticsMkExamVenueCode() {
      return FixedStringAttr.valueOf(importView.OnHighExamPaperVenueStatisticsMkExamVenueCode, 7);
   }
   public void setOnHighExamPaperVenueStatisticsMkExamVenueCode(String s)
      throws PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      if (s.length() > 7) {
         throw new PropertyVetoException("OnHighExamPaperVenueStatisticsMkExamVenueCode must be <= 7 characters.",
               new PropertyChangeEvent (this, "OnHighExamPaperVenueStatisticsMkExamVenueCode", null, null));
      }
      importView.OnHighExamPaperVenueStatisticsMkExamVenueCode = FixedStringAttr.valueOf(s, (short)7);
   }
 
   public short getOnHighExamPaperVenueStatisticsNr() {
      return importView.OnHighExamPaperVenueStatisticsNr;
   }
   public void setOnHighExamPaperVenueStatisticsNr(short s)
      throws PropertyVetoException {
      if (java.lang.Math.abs(s) >= 10.0) {
         throw new PropertyVetoException("OnHighExamPaperVenueStatisticsNr has more than 1 digits.",
               new PropertyChangeEvent (this, "OnHighExamPaperVenueStatisticsNr", null, null));
      }
      importView.OnHighExamPaperVenueStatisticsNr = ShortAttr.valueOf(s);
   }
   public void setAsStringOnHighExamPaperVenueStatisticsNr(String s)
      throws PropertyVetoException {
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("OnHighExamPaperVenueStatisticsNr is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "OnHighExamPaperVenueStatisticsNr", null, null));
      }
      try {
          setOnHighExamPaperVenueStatisticsNr(Short.parseShort(s) );
      } catch (NumberFormatException e) {
          throw new PropertyVetoException("OnHighExamPaperVenueStatisticsNr is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "OnHighExamPaperVenueStatisticsNr", null, null));
      }
   ...
   public short getInLowExamPaperVenueStatisticsExamYear() {
      return importView.InLowExamPaperVenueStatisticsExamYear;
   }
   public void setInLowExamPaperVenueStatisticsExamYear(short s)
      throws PropertyVetoException {
      if (java.lang.Math.abs(s) >= 10000.0) {
         throw new PropertyVetoException("InLowExamPaperVenueStatisticsExamYear has more than 4 digits.",
               new PropertyChangeEvent (this, "InLowExamPaperVenueStatisticsExamYear", null, null));
      }
      importView.InLowExamPaperVenueStatisticsExamYear = ShortAttr.valueOf(s);
   }
   public void setAsStringInLowExamPaperVenueStatisticsExamYear(String s)
      throws PropertyVetoException {
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("InLowExamPaperVenueStatisticsExamYear is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InLowExamPaperVenueStatisticsExamYear", null, null));
      }
      try {
          setInLowExamPaperVenueStatisticsExamYear(Short.parseShort(s) );
      } catch (NumberFormatException e) {
          throw new PropertyVetoException("InLowExamPaperVenueStatisticsExamYear is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InLowExamPaperVenueStatisticsExamYear", null, null));
      }
   ...
   public short getInLowExamPaperVenueStatisticsMkExamPeriodCode() {
      return importView.InLowExamPaperVenueStatisticsMkExamPeriodCode;
   }
   public void setInLowExamPaperVenueStatisticsMkExamPeriodCode(short s)
      throws PropertyVetoException {
      if (java.lang.Math.abs(s) >= 100.0) {
         throw new PropertyVetoException("InLowExamPaperVenueStatisticsMkExamPeriodCode has more than 2 digits.",
               new PropertyChangeEvent (this, "InLowExamPaperVenueStatisticsMkExamPeriodCode", null, null));
      }
      importView.InLowExamPaperVenueStatisticsMkExamPeriodCode = ShortAttr.valueOf(s);
   }
   public void setAsStringInLowExamPaperVenueStatisticsMkExamPeriodCode(String s)
      throws PropertyVetoException {
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("InLowExamPaperVenueStatisticsMkExamPeriodCode is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InLowExamPaperVenueStatisticsMkExamPeriodCode", null, null));
      }
      try {
          setInLowExamPaperVenueStatisticsMkExamPeriodCode(Short.parseShort(s) );
      } catch (NumberFormatException e) {
          throw new PropertyVetoException("InLowExamPaperVenueStatisticsMkExamPeriodCode is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InLowExamPaperVenueStatisticsMkExamPeriodCode", null, null));
      }
   ...
   public String getInLowExamPaperVenueStatisticsMkStudyUnitCode() {
      return FixedStringAttr.valueOf(importView.InLowExamPaperVenueStatisticsMkStudyUnitCode, 7);
   }
   public void setInLowExamPaperVenueStatisticsMkStudyUnitCode(String s)
      throws PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      if (s.length() > 7) {
         throw new PropertyVetoException("InLowExamPaperVenueStatisticsMkStudyUnitCode must be <= 7 characters.",
               new PropertyChangeEvent (this, "InLowExamPaperVenueStatisticsMkStudyUnitCode", null, null));
      }
      importView.InLowExamPaperVenueStatisticsMkStudyUnitCode = FixedStringAttr.valueOf(s, (short)7);
   }
 
   public String getInLowExamPaperVenueStatisticsMkExamVenueCode() {
      return FixedStringAttr.valueOf(importView.InLowExamPaperVenueStatisticsMkExamVenueCode, 7);
   }
   public void setInLowExamPaperVenueStatisticsMkExamVenueCode(String s)
      throws PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      if (s.length() > 7) {
         throw new PropertyVetoException("InLowExamPaperVenueStatisticsMkExamVenueCode must be <= 7 characters.",
               new PropertyChangeEvent (this, "InLowExamPaperVenueStatisticsMkExamVenueCode", null, null));
      }
      importView.InLowExamPaperVenueStatisticsMkExamVenueCode = FixedStringAttr.valueOf(s, (short)7);
   }
 
   public short getInLowExamPaperVenueStatisticsNr() {
      return importView.InLowExamPaperVenueStatisticsNr;
   }
   public void setInLowExamPaperVenueStatisticsNr(short s)
      throws PropertyVetoException {
      if (java.lang.Math.abs(s) >= 10.0) {
         throw new PropertyVetoException("InLowExamPaperVenueStatisticsNr has more than 1 digits.",
               new PropertyChangeEvent (this, "InLowExamPaperVenueStatisticsNr", null, null));
      }
      importView.InLowExamPaperVenueStatisticsNr = ShortAttr.valueOf(s);
   }
   public void setAsStringInLowExamPaperVenueStatisticsNr(String s)
      throws PropertyVetoException {
      if (s == null || s.length() == 0) {
          throw new PropertyVetoException("InLowExamPaperVenueStatisticsNr is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InLowExamPaperVenueStatisticsNr", null, null));
      }
      try {
          setInLowExamPaperVenueStatisticsNr(Short.parseShort(s) );
      } catch (NumberFormatException e) {
          throw new PropertyVetoException("InLowExamPaperVenueStatisticsNr is not a valid numeric value: " + s,
                                          new PropertyChangeEvent (this, "InLowExamPaperVenueStatisticsNr", null, null));
      }
   ...
   public String getOut10RedCsfStringsString40() {
      return FixedStringAttr.valueOf(exportView.Out10RedCsfStringsString40, 40);
   }
 
   public int getOutTotMcqOutstIefSuppliedCount() {
      return exportView.OutTotMcqOutstIefSuppliedCount;
   }
 
   public int getOutTotMcqIefSuppliedCount() {
      return exportView.OutTotMcqIefSuppliedCount;
   }
 
   public int getOutTotOutstandingIefSuppliedCount() {
      return exportView.OutTotOutstandingIefSuppliedCount;
   }
 
   public int getOutTotReceivedIefSuppliedCount() {
      return exportView.OutTotReceivedIefSuppliedCount;
   }
 
   public int getOutTotAbsentIefSuppliedCount() {
      return exportView.OutTotAbsentIefSuppliedCount;
   }
 
   public int getOutTotExpectedIefSuppliedCount() {
      return exportView.OutTotExpectedIefSuppliedCount;
   }
   ...
   public String getOutGWsExamVenueEngName(int index) throws ArrayIndexOutOfBoundsException {
      if (49 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 49, not: " + index);
      }
      return FixedStringAttr.valueOf(exportView.OutGWsExamVenueEngName[index], 28);
   }
 
   public String getOutGCsfStringsString1(int index) throws ArrayIndexOutOfBoundsException {
      if (49 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 49, not: " + index);
      }
      return FixedStringAttr.valueOf(exportView.OutGCsfStringsString1[index], 1);
   }
 
   public int getOutGOutstandingIefSuppliedCount(int index) throws ArrayIndexOutOfBoundsException {
      if (49 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 49, not: " + index);
      }
      return exportView.OutGOutstandingIefSuppliedCount[index];
   }
 
   public int getOutGMcqOutstIefSuppliedCount(int index) throws ArrayIndexOutOfBoundsException {
      if (49 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 49, not: " + index);
      }
      return exportView.OutGMcqOutstIefSuppliedCount[index];
   }
 
   public short getOutGExamPaperVenueStatisticsExamYear(int index) throws ArrayIndexOutOfBoundsException {
      if (49 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 49, not: " + index);
      }
      return exportView.OutGExamPaperVenueStatisticsExamYear[index];
   }
 
   public short getOutGExamPaperVenueStatisticsMkExamPeriodCode(int index) throws ArrayIndexOutOfBoundsException {
      if (49 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 49, not: " + index);
      }
      return exportView.OutGExamPaperVenueStatisticsMkExamPeriodCode[index];
   }
 
   public String getOutGExamPaperVenueStatisticsMkStudyUnitCode(int index) throws ArrayIndexOutOfBoundsException {
      if (49 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 49, not: " + index);
      }
      return FixedStringAttr.valueOf(exportView.OutGExamPaperVenueStatisticsMkStudyUnitCode[index], 7);
   }
 
   public String getOutGExamPaperVenueStatisticsMkExamVenueCode(int index) throws ArrayIndexOutOfBoundsException {
      if (49 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 49, not: " + index);
      }
      return FixedStringAttr.valueOf(exportView.OutGExamPaperVenueStatisticsMkExamVenueCode[index], 7);
   }
 
   public short getOutGExamPaperVenueStatisticsNr(int index) throws ArrayIndexOutOfBoundsException {
      if (49 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 49, not: " + index);
      }
      return exportView.OutGExamPaperVenueStatisticsNr[index];
   }
 
   public String getOutGExamPaperVenueStatisticsStatusCode(int index) throws ArrayIndexOutOfBoundsException {
      if (49 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 49, not: " + index);
      }
      return FixedStringAttr.valueOf(exportView.OutGExamPaperVenueStatisticsStatusCode[index], 1);
   }
 
   public int getOutGExamPaperVenueStatisticsNumberExpected(int index) throws ArrayIndexOutOfBoundsException {
      if (49 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 49, not: " + index);
      }
      return exportView.OutGExamPaperVenueStatisticsNumberExpected[index];
   }
 
   public int getOutGExamPaperVenueStatisticsNumberReceived(int index) throws ArrayIndexOutOfBoundsException {
      if (49 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 49, not: " + index);
      }
      return exportView.OutGExamPaperVenueStatisticsNumberReceived[index];
   }
 
   public int getOutGExamPaperVenueStatisticsNumberAbsent(int index) throws ArrayIndexOutOfBoundsException {
      if (49 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 49, not: " + index);
      }
      return exportView.OutGExamPaperVenueStatisticsNumberAbsent[index];
   }
 
   public int getOutGExamPaperVenueStatisticsNumberMcqReceived(int index) throws ArrayIndexOutOfBoundsException {
      if (49 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 49, not: " + index);
      }
      return exportView.OutGExamPaperVenueStatisticsNumberMcqReceived[index];
   }
