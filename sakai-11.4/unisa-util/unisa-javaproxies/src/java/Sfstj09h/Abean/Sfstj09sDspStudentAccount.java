 ...
 */
public class Sfstj09sDspStudentAccount  implements ActionListener, java.io.Serializable  {
 
   //  Use final String for the bean name
   public static final String BEANNAME = new String("Sfstj09sDspStudentAccount");
   ...
   public Sfstj09sDspStudentAccount() {
      super();
   ...
   private Sfstj09sDspStudentAccountOperation oper = null;
   ...
   public void execute()  throws PropertyVetoException {
      try  {
         if (oper == null) {
            oper = new Sfstj09sDspStudentAccountOperation(this);
         ...
         oper.doSfstj09sDspStudentAccountOperation();
   ...
   private class operListener implements ActionListener, java.io.Serializable  {
      private Sfstj09sDspStudentAccount rP;
      operListener(Sfstj09sDspStudentAccount r)  {
         rP = r;
      }
      public void actionPerformed(ActionEvent aEvent)  {
         if (Trace.isTracing(Trace.MASK_APPLICATION))
         {
            Trace.record(Trace.MASK_APPLICATION, "Sfstj09sDspStudentAccount", "Listener heard that Sfstj09sDspStudentAccountOperation completed with " + 
   ...
   private void notifyCompletionListeners()  {
      if (Trace.isTracing(Trace.MASK_APPLICATION))
      {
         Trace.record(Trace.MASK_APPLICATION, BEANNAME, "notifying listeners of completion of operation Sfstj09sDspStudentAccount ()\n");
      }
      Vector targets;
      ...
      actionEvt = new ActionEvent(this, 0, "Completion.Sfstj09sDspStudentAccount");
   ...
   private void notifyExceptionListeners(String s)  {
      if (Trace.isTracing(Trace.MASK_APPLICATION))
      {
         Trace.record(Trace.MASK_APPLICATION, BEANNAME, "notifying listeners of exception of operation Sfstj09sDspStudentAccount ()\n");
      }
      Vector targets;
      ActionEvent actionEvt = null;
      String failCommand = "Exception.Sfstj09sDspStudentAccount";
      synchronized (this)  {
   ...
   public void clear()  throws PropertyVetoException  {
      ...
      importView.reset();
      exportView.reset();
      importView.InClassGroup_MA = IntAttr.valueOf(InClassGroupMax);
      ...
      exportView.OutClassGroup_MA = IntAttr.getDefaultValue();
      ...
      exportView.OutStudentAccountClassificationInUseFlag = FixedStringAttr.valueOf("Y", 1);
   ...
   Sfstj09h.SFSTJ09S_IA importView = Sfstj09h.SFSTJ09S_IA.getInstance();
   Sfstj09h.SFSTJ09S_OA exportView = Sfstj09h.SFSTJ09S_OA.getInstance();
   ...
   public final int InClassGroupMax = 50;
   public short getInClassGroupCount() {
      return (short)(importView.InClassGroup_MA);
   };
 
   public void setInClassGroupCount(short s) throws PropertyVetoException {
      if (s < 0 || s > InClassGroupMax) {
         throw new PropertyVetoException("InClassGroupCount value is not a valid value. (0 to 50)",
               new PropertyChangeEvent (this, "InClassGroupCount", null, null));
      } else {
         importView.InClassGroup_MA = IntAttr.valueOf((int)s);
      }
   }
 
   public String getInClassGStudentAccountClassificationCode(int index) throws ArrayIndexOutOfBoundsException {
      if (49 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 49, not: " + index);
      }
      return FixedStringAttr.valueOf(importView.InClassGStudentAccountClassificationCode[index], 2);
   }
   public void setInClassGStudentAccountClassificationCode(int index, String s)
      ...
      if (s.length() > 2) {
         throw new PropertyVetoException("InClassGStudentAccountClassificationCode must be <= 2 characters.",
               new PropertyChangeEvent (this, "InClassGStudentAccountClassificationCode", null, null));
      }
      importView.InClassGStudentAccountClassificationCode[index] = FixedStringAttr.valueOf(s, (short)2);
   }
 
   public String getInClassGStudentAccountClassificationDescription(int index) throws ArrayIndexOutOfBoundsException {
      if (49 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 49, not: " + index);
      }
      return FixedStringAttr.valueOf(importView.InClassGStudentAccountClassificationDescription[index], 30);
   }
   public void setInClassGStudentAccountClassificationDescription(int index, String s)
      throws ArrayIndexOutOfBoundsException, PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      ...
      if (s.length() > 30) {
         throw new PropertyVetoException("InClassGStudentAccountClassificationDescription must be <= 30 characters.",
               new PropertyChangeEvent (this, "InClassGStudentAccountClassificationDescription", null, null));
      }
      importView.InClassGStudentAccountClassificationDescription[index] = FixedStringAttr.valueOf(s, (short)30);
   }
   ...
   public void setInHistoryIefSuppliedFlag(String s)
      ...
      Sfstj09sDspStudentAccountIefSuppliedFlagPropertyEditor pe = new Sfstj09sDspStudentAccountIefSuppliedFlagPropertyEditor();
   ...
   public String getInDisplayNameIefSuppliedFlag() {
      return FixedStringAttr.valueOf(importView.InDisplayNameIefSuppliedFlag, 1);
   }
   public void setInDisplayNameIefSuppliedFlag(String s)
      throws PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      Sfstj09sDspStudentAccountIefSuppliedFlagPropertyEditor pe = new Sfstj09sDspStudentAccountIefSuppliedFlagPropertyEditor();
      if (pe.checkTag(s) == false) {
         throw new PropertyVetoException("InDisplayNameIefSuppliedFlag value  \"" + s + "\"  is not a permitted value.",
               new PropertyChangeEvent (this, "InDisplayNameIefSuppliedFlag", null, null));
      }
      if (s.length() > 1) {
         throw new PropertyVetoException("InDisplayNameIefSuppliedFlag must be <= 1 characters.",
               new PropertyChangeEvent (this, "InDisplayNameIefSuppliedFlag", null, null));
      }
      importView.InDisplayNameIefSuppliedFlag = FixedStringAttr.valueOf(s, (short)1);
   }
   ...
   public String getInRetrieveIefSuppliedFlag() {
      return FixedStringAttr.valueOf(importView.InRetrieveIefSuppliedFlag, 1);
   }
   public void setInRetrieveIefSuppliedFlag(String s)
      throws PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      Sfstj09sDspStudentAccountIefSuppliedFlagPropertyEditor pe = new Sfstj09sDspStudentAccountIefSuppliedFlagPropertyEditor();
      if (pe.checkTag(s) == false) {
         throw new PropertyVetoException("InRetrieveIefSuppliedFlag value  \"" + s + "\"  is not a permitted value.",
               new PropertyChangeEvent (this, "InRetrieveIefSuppliedFlag", null, null));
      }
      if (s.length() > 1) {
         throw new PropertyVetoException("InRetrieveIefSuppliedFlag must be <= 1 characters.",
               new PropertyChangeEvent (this, "InRetrieveIefSuppliedFlag", null, null));
      }
      importView.InRetrieveIefSuppliedFlag = FixedStringAttr.valueOf(s, (short)1);
   }
 
   public String getInCsfStringsString78() {
      return FixedStringAttr.valueOf(importView.InCsfStringsString78, 78);
   }
   public void setInCsfStringsString78(String s)
      throws PropertyVetoException {
      if (s.length() > 78) {
         throw new PropertyVetoException("InCsfStringsString78 must be <= 78 characters.",
               new PropertyChangeEvent (this, "InCsfStringsString78", null, null));
      }
      importView.InCsfStringsString78 = FixedStringAttr.valueOf(s, (short)78);
   }
   ...
   public void setInStudentAccountRefundBlockedInd(short s)
      throws PropertyVetoException {
      Sfstj09sDspStudentAccountStudentAccountRefundBlockedIndPropertyEditor pe = new Sfstj09sDspStudentAccountStudentAccountRefundBlockedIndPropertyEditor();
   ...
   public String getInStudentAccountLibraryDebtFlag() {
      return StringAttr.valueOf(importView.InStudentAccountLibraryDebtFlag);
   }
   public void setInStudentAccountLibraryDebtFlag(String s)
      throws PropertyVetoException {
      if (s != null) {
          s = s.toUpperCase();
      }
      if (s.length() > 1) {
         throw new PropertyVetoException("InStudentAccountLibraryDebtFlag must be <= 1 characters.",
               new PropertyChangeEvent (this, "InStudentAccountLibraryDebtFlag", null, null));
      }
      importView.InStudentAccountLibraryDebtFlag = StringAttr.valueOf(s, (short)1);
   }
   ...
   public void setInStudentAccountClassificationInUseFlag(String s)
      ...
      Sfstj09sDspStudentAccountStudentAccountClassificationInUseFlagPropertyEditor pe = new Sfstj09sDspStudentAccountStudentAccountClassificationInUseFlagPropertyEditor();
      if (pe.checkTag(s) == false) {
   ...
   public void setInWsStudentAnnualRecordLateRegistrationFlag(String s)
      ...
      Sfstj09sDspStudentAccountWsStudentAnnualRecordLateRegistrationFlagPropertyEditor pe = new Sfstj09sDspStudentAccountWsStudentAnnualRecordLateRegistrationFlagPropertyEditor();
      if (pe.checkTag(s) == false) {
   ...
   public void setInWsStudentLibraryBlackList(short s)
      throws PropertyVetoException {
      Sfstj09sDspStudentAccountWsStudentLibraryBlackListPropertyEditor pe = new Sfstj09sDspStudentAccountWsStudentLibraryBlackListPropertyEditor();
      if (pe.checkTag(String.valueOf(s)) == false) {
   ...
   public void setInWsStudentPhasedOutStatus(short s)
      throws PropertyVetoException {
      Sfstj09sDspStudentAccountWsStudentPhasedOutStatusPropertyEditor pe = new Sfstj09sDspStudentAccountWsStudentPhasedOutStatusPropertyEditor();
      if (pe.checkTag(String.valueOf(s)) == false) {
   ...
   public void setInWsStudentFinancialBlockFlag(String s)
      ...
      Sfstj09sDspStudentAccountWsStudentFinancialBlockFlagPropertyEditor pe = new Sfstj09sDspStudentAccountWsStudentFinancialBlockFlagPropertyEditor();
      if (pe.checkTag(s) == false) {
   ...
   public void setInWsStudentExamFeesDebtFlag(String s)
      ...
      Sfstj09sDspStudentAccountWsStudentExamFeesDebtFlagPropertyEditor pe = new Sfstj09sDspStudentAccountWsStudentExamFeesDebtFlagPropertyEditor();
      if (pe.checkTag(s) == false) {
   ...
   public final int OutClassGroupMax = 50;
   public short getOutClassGroupCount() {
      return (short)(exportView.OutClassGroup_MA);
   };
 
   public String getOutClassGStudentAccountClassificationCode(int index) throws ArrayIndexOutOfBoundsException {
      if (49 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 49, not: " + index);
      }
      return FixedStringAttr.valueOf(exportView.OutClassGStudentAccountClassificationCode[index], 2);
   }
 
   public String getOutClassGStudentAccountClassificationDescription(int index) throws ArrayIndexOutOfBoundsException {
      if (49 < index || index < 0) {
         throw new ArrayIndexOutOfBoundsException("index range must be from 0 to 49, not: " + index);
      }
      return FixedStringAttr.valueOf(exportView.OutClassGStudentAccountClassificationDescription[index], 30);
   }
   ...
   public String getOutDisplNameIefSuppliedFlag() {
      return FixedStringAttr.valueOf(exportView.OutDisplNameIefSuppliedFlag, 1);
   }
 
   public String getOutLclWsAddressAuditFlag() {
      return FixedStringAttr.valueOf(exportView.OutLclWsAddressAuditFlag, 1);
   }
   ...
   public String getOutLclWsAddressAddressReferenceFlag() {
      return FixedStringAttr.valueOf(exportView.OutLclWsAddressAddressReferenceFlag, 1);
   }
   ...
   public String getOutLclWsAddressFaxNumber() {
      return FixedStringAttr.valueOf(exportView.OutLclWsAddressFaxNumber, 28);
   }
   ...
   public Calendar getOutLclWsAddressAddressTimestamp() {
      return TimestampAttr.toCalendar(exportView.OutLclWsAddressAddressTimestamp);
   }
   public String getAsStringOutLclWsAddressAddressTimestamp() {
      return TimestampAttr.toString(exportView.OutLclWsAddressAddressTimestamp);
   }
 
   public Calendar getOutLclWsAddressContactTimestamp() {
      return TimestampAttr.toCalendar(exportView.OutLclWsAddressContactTimestamp);
   }
   public String getAsStringOutLclWsAddressContactTimestamp() {
      return TimestampAttr.toString(exportView.OutLclWsAddressContactTimestamp);
   }
   ...
   public String getOutLclWsAddressCategoryDescription() {
      return FixedStringAttr.valueOf(exportView.OutLclWsAddressCategoryDescription, 28);
   }
 
   public String getOutLclWsAddressHomeNumber() {
      return FixedStringAttr.valueOf(exportView.OutLclWsAddressHomeNumber, 28);
   }
 
   public String getOutLclWsAddressWorkNumber() {
      return FixedStringAttr.valueOf(exportView.OutLclWsAddressWorkNumber, 28);
   }
   ...
   public int getOutLdStudentAccountMkStudentNr() {
      return exportView.OutLdStudentAccountMkStudentNr;
   }
 
   public double getOutLdStudentAccountBalance() {
      return exportView.OutLdStudentAccountBalance;
   }
 
   public String getOutLdStudentAccountClassificationCode() {
      return FixedStringAttr.valueOf(exportView.OutLdStudentAccountClassificationCode, 2);
   }
 
   public int getOutSpesLibraryPatronsPatronNr() {
      return exportView.OutSpesLibraryPatronsPatronNr;
   }
 
   public String getOutSpesLibraryPatronsSurname() {
      return FixedStringAttr.valueOf(exportView.OutSpesLibraryPatronsSurname, 28);
   }
 
   public String getOutSpesLibraryPatronsInitials() {
      return FixedStringAttr.valueOf(exportView.OutSpesLibraryPatronsInitials, 10);
   }
 
   public String getOutSpesLibraryPatronsTitle() {
      return FixedStringAttr.valueOf(exportView.OutSpesLibraryPatronsTitle, 10);
   }
 
   public String getOutSpesLibraryPatronsMkCorrespondence() {
      return FixedStringAttr.valueOf(exportView.OutSpesLibraryPatronsMkCorrespondence, 2);
   }
   ...
   public String getOutWsEmployerContactPerson() {
      return FixedStringAttr.valueOf(exportView.OutWsEmployerContactPerson, 28);
   }
 
   public String getOutWsEmployerEngName() {
      return FixedStringAttr.valueOf(exportView.OutWsEmployerEngName, 28);
   }
 
   public String getOutWsEmployerAfrName() {
      return FixedStringAttr.valueOf(exportView.OutWsEmployerAfrName, 28);
   }
 
   public String getOutWsEmployerLanguageCode() {
      return FixedStringAttr.valueOf(exportView.OutWsEmployerLanguageCode, 2);
   }
 
   public short getOutWsEmployerCode() {
      return exportView.OutWsEmployerCode;
   }
   ...
   public String getOutStudentAccountLibraryDebtFlag() {
      return StringAttr.valueOf(exportView.OutStudentAccountLibraryDebtFlag);
   }
   ...
   public String getOutStudentAccountClassificationDescription() {
      return FixedStringAttr.valueOf(exportView.OutStudentAccountClassificationDescription, 30);
   }
 
   public String getOutStudentAccountClassificationInUseFlag() {
      return FixedStringAttr.valueOf(exportView.OutStudentAccountClassificationInUseFlag, 1);
   }
 
   public String getOutStudentAccountClassificationStudyFeeDebt() {
      return StringAttr.valueOf(exportView.OutStudentAccountClassificationStudyFeeDebt);
   }
 
   public String getOutStudentAccountClassificationControlEntity() {
      return StringAttr.valueOf(exportView.OutStudentAccountClassificationControlEntity);
   }
 
   public String getOutStudentAccountClassificationControlAccount() {
      return StringAttr.valueOf(exportView.OutStudentAccountClassificationControlAccount);
   }
