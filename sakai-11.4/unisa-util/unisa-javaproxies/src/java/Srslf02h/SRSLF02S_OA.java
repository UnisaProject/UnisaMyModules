...
//
//    Name: SRSLF02S_OA                      Date: 2015/03/05
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
/**
 * Internal data view storage for: SRSLF02S_OA
 **/
public class SRSLF02S_OA extends ViewBase implements IExportView, Serializable
{
  ...
  public SRSLF02S_OA(SRSLF02S_OA orig)
  {
    copyFrom(orig);
  }
  /**
  ...
  public static SRSLF02S_OA getInstance()
  {
    return new SRSLF02S_OA();
  }
  /**
  ...
  public static VDF getViewDefinition()
  {
    ...
    {
      VDFEntry [] vdfEntries = {
        new VDFEntry((int)1, "", "OutWsStaff", "WsStaff", "Persno", 
          VDFEntry.TYPE_INT, (short)1, (short)0, 8, (short)0, null), 
        new VDFEntry((int)2, "", "OutWsStaff", "WsStaff", "MkRcCode", 
          VDFEntry.TYPE_STRING, (short)1, (short)0, 6, (short)0, null), 
        new VDFEntry((int)3, "", "OutSmsRequest", "SmsRequest", "BatchNr", 
          VDFEntry.TYPE_INT, (short)1, (short)0, 8, (short)0, null), 
        new VDFEntry((int)4, "", "OutSmsRequest", "SmsRequest", "MkRcCode", 
          VDFEntry.TYPE_STRING, (short)1, (short)0, 6, (short)0, null), 
        new VDFEntry((int)5, "", "OutSmsLog", "SmsLog", "MkBatchNr", 
          VDFEntry.TYPE_INT, (short)1, (short)0, 8, (short)0, null), 
        new VDFEntry((int)6, "", "OutSmsLog", "SmsLog", "SequenceNr", 
          VDFEntry.TYPE_INT, (short)1, (short)0, 8, (short)0, null), 
        new VDFEntry((int)7, "", "OutSmsLog", "SmsLog", "ReferenceNr", 
          VDFEntry.TYPE_INT, (short)1, (short)0, 8, (short)0, null), 
        new VDFEntry((int)8, "", "OutSmsLog", "SmsLog", "CellNr", 
          VDFEntry.TYPE_STRING, (short)1, (short)0, 20, (short)0, null), 
        new VDFEntry((int)9, "", "OutSmsLog", "SmsLog", "Message", 
          VDFEntry.TYPE_STRING, (short)1, (short)0, 160, (short)0, null), 
        new VDFEntry((int)10, "", "OutSmsLog", "SmsLog", "SentOn", 
          VDFEntry.TYPE_TIMESTAMP, (short)1, (short)0, 20, (short)0, null), 
        new VDFEntry((int)11, "", "OutSmsLog", "SmsLog", "DeliveredOn", 
          VDFEntry.TYPE_TIMESTAMP, (short)1, (short)0, 20, (short)0, null), 
        new VDFEntry((int)12, "", "OutSmsLog", "SmsLog", "MessageStatus", 
          VDFEntry.TYPE_STRING, (short)1, (short)0, 7, (short)0, null), 
        new VDFEntry((int)13, "", "OutSmsLog", "SmsLog", "MkPersNr", 
          VDFEntry.TYPE_INT, (short)1, (short)0, 8, (short)0, null), 
        new VDFEntry((int)14, "", "OutSmsLog", "SmsLog", "LogRefId", 
          VDFEntry.TYPE_DOUBLE, (short)1, (short)0, 11, (short)0, null), 
        new VDFEntry((int)15, "", "OutSecurityWsUser", "WsUser", "Number", 
          VDFEntry.TYPE_INT, (short)1, (short)0, 8, (short)0, null), 
        new VDFEntry((int)16, "", "OutStaffNameCsfStrings", "CsfStrings", 
          "String30", VDFEntry.TYPE_STRING, (short)1, (short)0, 30, (short)0, 
          null), 
        new VDFEntry((int)17, "OutLogGroup", "", "", "MA", VDFEntry.TYPE_INT, (
          short)1, (short)0, 4, (short)0, null), 
        new VDFEntry((int)18, "OutLogGroup", "", "", "AC", VDFEntry.TYPE_CHAR, (
          short)50, (short)0, 1, (short)0, null), 
        new VDFEntry((int)19, "OutLogGroup", "OutGSmsLog", "SmsLog", "MkBatchNr"
          , VDFEntry.TYPE_INT, (short)50, (short)0, 8, (short)0, null), 
        new VDFEntry((int)20, "OutLogGroup", "OutGSmsLog", "SmsLog", 
          "ReferenceNr", VDFEntry.TYPE_INT, (short)50, (short)0, 8, (short)0, 
          null), 
        new VDFEntry((int)21, "OutLogGroup", "OutGSmsLog", "SmsLog", "CellNr", 
          VDFEntry.TYPE_STRING, (short)50, (short)0, 20, (short)0, null), 
        new VDFEntry((int)22, "OutLogGroup", "OutGSmsLog", "SmsLog", "Message", 
          VDFEntry.TYPE_STRING, (short)50, (short)0, 160, (short)0, null), 
        new VDFEntry((int)23, "OutLogGroup", "OutGSmsLog", "SmsLog", "SentOn", 
          VDFEntry.TYPE_TIMESTAMP, (short)50, (short)0, 20, (short)0, null), 
        new VDFEntry((int)24, "OutLogGroup", "OutGSmsLog", "SmsLog", 
          "MessageStatus", VDFEntry.TYPE_STRING, (short)50, (short)0, 7, (short)
          0, null), 
        new VDFEntry((int)25, "OutLogGroup", "OutGSmsLog", "SmsLog", 
          "SequenceNr", VDFEntry.TYPE_INT, (short)50, (short)0, 8, (short)0, 
          null), 
        new VDFEntry((int)26, "OutLogGroup", "OutGLogCsfLineActionBar", 
          "CsfLineActionBar", "Action", VDFEntry.TYPE_STRING, (short)50, (short)
          0, 1, (short)0, null), 
        new VDFEntry((int)27, "OutLogGroup", "OutGLogCsfLineActionBar", 
          "CsfLineActionBar", "SelectionFlag", VDFEntry.TYPE_STRING, (short)50, 
          (short)0, 1, (short)0, null), 
        new VDFEntry((int)28, "OutLogGroup", "OutGMessageStatusDescCsfStrings", 
          "CsfStrings", "String30", VDFEntry.TYPE_STRING, (short)50, (short)0, 
          30, (short)0, null), 
        new VDFEntry((int)29, "", "OutCsfStrings", "CsfStrings", "String500", 
  ...
  public void setFromVDF(VDF vdf)
  {
    ...
    {
      OutWsStaffPersno = ((Integer)vdf.getEntries()[0].getDataValue().getObject(
        )).intValue();
    }
    else 
    {
    ...
    {
      OutWsStaffMkRcCode = ((String)vdf.getEntries()[1].getDataValue()
        .getObject());
    }
    else 
    {
    ...
    {
      OutSmsRequestBatchNr = ((Integer)vdf.getEntries()[2].getDataValue()
        .getObject()).intValue();
    }
    else 
    {
    ...
    {
      OutSmsRequestMkRcCode = ((String)vdf.getEntries()[3].getDataValue()
        .getObject());
    }
    else 
    {
    ...
    {
      OutSmsLogMkBatchNr = ((Integer)vdf.getEntries()[4].getDataValue()
        .getObject()).intValue();
    }
    else 
    {
    ...
    {
      OutSmsLogSequenceNr = ((Integer)vdf.getEntries()[5].getDataValue()
        .getObject()).intValue();
    }
    else 
    {
    ...
    {
      OutSmsLogReferenceNr = ((Integer)vdf.getEntries()[6].getDataValue()
        .getObject()).intValue();
    }
    else 
    {
    ...
    {
      OutSmsLogCellNr = ((String)vdf.getEntries()[7].getDataValue().getObject())
        ;
    }
    else 
    {
    ...
    {
      OutSmsLogMessage = ((String)vdf.getEntries()[8].getDataValue().getObject()
        );
    }
    else 
    {
    ...
    {
      OutSmsLogSentOn = ((String)vdf.getEntries()[9].getDataValue().getObject())
        ;
    }
    else 
    {
    ...
    {
      OutSmsLogDeliveredOn = ((String)vdf.getEntries()[10].getDataValue()
        .getObject());
    }
    else 
    {
    ...
    {
      OutSmsLogMessageStatus = ((String)vdf.getEntries()[11].getDataValue()
        .getObject());
    }
    else 
    {
    ...
    {
      OutSmsLogMkPersNr = ((Integer)vdf.getEntries()[12].getDataValue()
        .getObject()).intValue();
    }
    else 
    {
    ...
    {
      OutSmsLogLogRefId = ((Double)vdf.getEntries()[13].getDataValue()
    ...
    {
      OutSecurityWsUserNumber = ((Integer)vdf.getEntries()[14].getDataValue()
        .getObject()).intValue();
    }
    else 
    {
    ...
    {
      OutStaffNameCsfStringsString30 = ((String)vdf.getEntries()[15]
    ...
    {
      OutLogGroup_MA = ((Integer)vdf.getEntries()[16].getDataValue().getObject()
        ).intValue();
    }
    else 
    {
    ...
    for(int adim0 = 0; adim0 < OutLogGroup_MA; adim0++)
    {
        ...
        adim0].getObject() != null )
      {
        OutLogGroup_AC[adim0] = ((Character)((VDFEntryObject [])vdf.getEntries()
          [17].getDataValue().getObject())[adim0].getObject()).charValue();
      }
      else 
      {
    ...
    for(int adim0 = 0; adim0 < OutLogGroup_MA; adim0++)
    {
        ...
        adim0].getObject() != null )
      {
        OutGSmsLogCellNr[adim0] = ((String)((VDFEntryObject [])vdf.getEntries()[
          20].getDataValue().getObject())[adim0].getObject());
      }
      else 
      {
    ...
    for(int adim0 = 0; adim0 < OutLogGroup_MA; adim0++)
    {
        ...
        adim0].getObject() != null )
      {
        OutGSmsLogMessage[adim0] = ((String)((VDFEntryObject [])vdf.getEntries()
          [21].getDataValue().getObject())[adim0].getObject());
      }
      else 
      {
    ...
    for(int adim0 = 0; adim0 < OutLogGroup_MA; adim0++)
    {
        ...
        adim0].getObject() != null )
      {
        OutGSmsLogSentOn[adim0] = ((String)((VDFEntryObject [])vdf.getEntries()[
          22].getDataValue().getObject())[adim0].getObject());
      }
      else 
      {
    ...
    {
      OutCsfStringsString500 = ((String)vdf.getEntries()[28].getDataValue()
        .getObject());
    }
    else 
    {
    ...
    {
      OutCsfClientServerCommunicationsReturnCode = ((Short)vdf.getEntries()[29]
    ...
    {
      OutCsfClientServerCommunicationsAction = ((String)vdf.getEntries()[33]
        .getDataValue().getObject());
    }
    else 
    {
    ...
    {
      OutCsfClientServerCommunicationsCancelFlag = ((String)vdf.getEntries()[46]
        .getDataValue().getObject());
    }
    else 
    {
  ...
  public VDF getVDF()
  {
    ...
    // predicate view item
    vdf.getEntries()[0].getDataValue().setObject(new Integer(OutWsStaffPersno))
      ;
    // predicate view item
    vdf.getEntries()[1].getDataValue().setObject(OutWsStaffMkRcCode);
    // predicate view item
    vdf.getEntries()[2].getDataValue().setObject(new Integer(
      OutSmsRequestBatchNr));
    // predicate view item
    vdf.getEntries()[3].getDataValue().setObject(OutSmsRequestMkRcCode);
    // predicate view item
    vdf.getEntries()[4].getDataValue().setObject(new Integer(OutSmsLogMkBatchNr)
      );
    // predicate view item
    ...
    // predicate view item
    vdf.getEntries()[7].getDataValue().setObject(OutSmsLogCellNr);
    // predicate view item
    vdf.getEntries()[8].getDataValue().setObject(OutSmsLogMessage);
    // predicate view item
    vdf.getEntries()[9].getDataValue().setObject(OutSmsLogSentOn);
    // predicate view item
    vdf.getEntries()[10].getDataValue().setObject(OutSmsLogDeliveredOn);
    // predicate view item
    vdf.getEntries()[11].getDataValue().setObject(OutSmsLogMessageStatus);
    // predicate view item
    vdf.getEntries()[12].getDataValue().setObject(new Integer(OutSmsLogMkPersNr)
      );
    // predicate view item
    vdf.getEntries()[13].getDataValue().setObject(new Double(OutSmsLogLogRefId))
      ;
    // predicate view item
    ...
    vdf.getEntries()[15].getDataValue().setObject(
      OutStaffNameCsfStringsString30);
    // group view current cardinality
    vdf.getEntries()[16].getDataValue().setObject(new Integer(OutLogGroup_MA));
    // group view active flags
    ...
    vdf.getEntries()[17].setCountUsed((short)OutLogGroup_MA);
    // current cardinality group view items
    for(int adim0 = 0; adim0 < 50; adim0++)
    {
    ...
    vdf.getEntries()[18].setCountUsed((short)OutLogGroup_MA);
    // current cardinality group view items
    for(int adim0 = 0; adim0 < 50; adim0++)
    {
    ...
    vdf.getEntries()[19].setCountUsed((short)OutLogGroup_MA);
    // current cardinality group view items
    for(int adim0 = 0; adim0 < 50; adim0++)
    {
    ...
    vdf.getEntries()[20].setCountUsed((short)OutLogGroup_MA);
    // current cardinality group view items
    for(int adim0 = 0; adim0 < 50; adim0++)
    {
    ...
    vdf.getEntries()[21].setCountUsed((short)OutLogGroup_MA);
    // current cardinality group view items
    for(int adim0 = 0; adim0 < 50; adim0++)
    {
    ...
    vdf.getEntries()[22].setCountUsed((short)OutLogGroup_MA);
    // current cardinality group view items
    for(int adim0 = 0; adim0 < 50; adim0++)
    {
    ...
    vdf.getEntries()[23].setCountUsed((short)OutLogGroup_MA);
    // current cardinality group view items
    for(int adim0 = 0; adim0 < 50; adim0++)
    {
    ...
    vdf.getEntries()[24].setCountUsed((short)OutLogGroup_MA);
    // current cardinality group view items
    for(int adim0 = 0; adim0 < 50; adim0++)
    {
    ...
    vdf.getEntries()[25].setCountUsed((short)OutLogGroup_MA);
    // current cardinality group view items
    for(int adim0 = 0; adim0 < 50; adim0++)
    {
    ...
    // predicate view item
    vdf.getEntries()[28].getDataValue().setObject(OutCsfStringsString500);
    // predicate view item
  ...
  {
    this.copyFrom((SRSLF02S_OA) orig);
  }
  
  /**
   * Sets the current instance based on the passed view.
   **/
  public void copyFrom(SRSLF02S_OA orig)
  {
