/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/metaobj/tags/sakai-10.4/metaobj-api/api/src/java/org/sakaiproject/metaobj/utils/ioc/FieldRetrievingFactoryBean.java $
 * $Id: FieldRetrievingFactoryBean.java 105079 2012-02-24 23:08:11Z ottenhoff@longsight.com $
 ***********************************************************************************
 *
...
public class FieldRetrievingFactoryBean implements FactoryBean, BeanNameAware, InitializingBean {
   ...
   public void afterPropertiesSet() throws ClassNotFoundException, NoSuchFieldException {
      ...
      if (this.targetClass == null && this.targetObject == null) {
         ...
         this.targetClass = ClassUtils.forName(className, null);
