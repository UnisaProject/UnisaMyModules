...
/**
 * This class has common methods in between import from site and IMS import process.
 */
abstract public class MeleteImportBaseImpl
{
	...
	/**
	 * Checks if the resource is an LTI Document. Used by IMS import to check if the file is LTI resource or an uploaded file.
	 * 
	 * @param content
	 * @return
	 */
	 ...
	 * @return
	 */
	protected String ReplaceEmbedMediaWithResourceURL(String contentEditor, String imgSrcPath, String imgActualPath, String courseId,
			String unZippedDirPath, String anchorStr)
	{
	...
	/**
	 * @param meleteUserPrefDB
	 *        the meleteUserPrefDB to set
	 */
