-- *********************************************************************
-- $URL: https://source.etudes.org/svn/apps/melete/tags/2.9.1forSakai/components/src/sql/mysql/melete29m12.sql $
-- $Id: melete29m12.sql 3641 2012-12-02 21:43:44Z ggolden $
-- *********************************************************************
...
CREATE TABLE `melete_special_access` (
  ...
  `OVERRIDE_ALLOWUNTIL` tinyint(1) default '0',
...
CREATE TABLE `melete_section_track_view` (
  ...
  `FIRST_VIEW_DATE` datetime default NULL,
