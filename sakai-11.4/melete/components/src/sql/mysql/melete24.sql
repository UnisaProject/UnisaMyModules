-- *********************************************************************
-- $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.9.1/components/src/sql/mysql/melete24.sql $
-- $Id: melete24.sql 56413 2008-12-19 22:20:19Z rashmi@etudes.org $
-- *********************************************************************
...
CREATE TABLE `melete_module_student_privs` (
  ...
  CONSTRAINT `FK_MMSP_MM` FOREIGN KEY(`MODULE_ID`) REFERENCES `melete_module`(`MODULE_ID`)
);
