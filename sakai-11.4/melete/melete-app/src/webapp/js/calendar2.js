...
function ambrosia_parse_timeStamp(displayStr)
{
	...
	var time = Number(displayStr); //parseInt(displayStr, 10); // Unisa-Changes: Changed the javascript function from parseInt To Number in order to check the entire date string! ETM
	...
	var datePart = displayParts[1] + " " + displayParts[0] + " " + displayParts[2]; //Unisa-Changes: swapped the array values around to get the correct date format
