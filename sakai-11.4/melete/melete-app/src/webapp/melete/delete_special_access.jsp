...
<!--
 ***********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/melete/tags/2.9.1forSakai/melete-app/src/webapp/melete/delete_special_access.jsp $
 * $Id: delete_special_access.jsp 3647 2012-12-02 22:30:41Z ggolden $  
 ***********************************************************************************
 *
 ...
 <h:form id="DeleteSpecialAccessForm">
  ...
  <table class="maintableCollapseWithBorder">
      ...
      <td width="100%" valign="top" >
       <table class="maintableCollapseWithBorder">
        <!-- show table with delete special_accesss -->
        ...
        <td width="100%" valign="top">
          ...
          <tr>
               ...
               <div class="actionBar" align="left">	
                	<h:commandButton id="delButton" action="#{specialAccessPage.deleteSpecialAccess}" value="#{msgs.im_continue}" accesskey="#{msgs.continue_access}" title="#{msgs.im_continue_text}" styleClass="BottomImgDelete"/>			
                    <h:commandButton id="cancelButton" action="#{specialAccessPage.cancelDeleteAccess}" value="#{msgs.im_cancel}" accesskey="#{msgs.cancel_access}" title="#{msgs.im_cancel_text}" styleClass="BottomImgCancel"/>
              	</div></td>
              </tr>			 
            </table>
      </td></tr></table>
