<!--
 ***********************************************************************************
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.9.1/melete-app/src/webapp/melete/view_navigate.jsp $
 * $Id: view_navigate.jsp 77082 2011-10-24 18:38:10Z rashmi@etudes.org $  
 ***********************************************************************************
 *
...
<h:panelGrid id="navSectionsItem" columns="5"  style=" border-width:medium; border-color: #E2E4E8">
	<h:column>
		<h:commandLink id="prevItem" actionListener="#{viewSectionsPage.goPrevNext}" immediate="true"  rendered="#{viewSectionsPage.prevSecId != 0}">
	...
	<h:column>
		<h:commandLink id="nextItem" actionListener="#{viewSectionsPage.goPrevNext}" immediate="true" rendered="#{viewSectionsPage.nextSecId != 0}">
