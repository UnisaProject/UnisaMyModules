...
<!-- top nav bar -->
	...
	<div class="meletePortletToolBarMessage"><img src="/etudes-melete-tool/images/document_exchange.gif" alt="" width="16" height="16" align="absmiddle"><h:outputText value="#{msgs.sort_modules_top_message}" /> </div>
