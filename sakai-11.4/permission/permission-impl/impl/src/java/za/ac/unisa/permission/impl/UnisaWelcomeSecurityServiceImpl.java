...
public class UnisaWelcomeSecurityServiceImpl {
	...
	public static final String SECURE_UPDATE = "welcome.update";
	...
	public void init()
	{
		...
		List l = functionManager.getRegisteredFunctions("welcome.");
