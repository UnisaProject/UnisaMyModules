...
<p><b style="color:red">WARNING:</b> Do not use this to share with someone
within Rutgers. Use it to share with someone outside, who doesn't have a
Rutgers NetID. That person will need to login using the email address and
a password that Sakai will send them.</p>
<p>To share with someone within Rutgers, click on "Select by" and
use "Browsing for people" to choose their name, or "Entering a user id"
to enter a NetID.
</p>
</div>
</c:if>
