/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/kernel/tags/sakai-10.5/kernel-private/src/main/java/org/sakaiproject/springframework/orm/hibernate/SakaiCacheProvider.java $
...
public class SakaiCacheProvider implements CacheProvider, ApplicationContextAware
{
	...
	public void stop()
	{
		...
		/* Unisa-change - Sonette - 24 August 
		 * Apply patch:
		 * https://jira.sakaiproject.org/browse/KNL-1295
		 * KNL-1295.patch
		 * 
		 * to solve this error:
		 * The full stack is in here.
 		 * org.springframework.orm.hibernate3.HibernateSystemException: java.lang.IllegalStateException: 
 		 * The org.sakaiproject.springframework.orm.hibernate.L2Cache 
 		 * Cache is not alive (STATUS_SHUTDOWN); nested exception is 
