/**********************************************************************************
 * $URL: https://source.sakaiproject.org/contrib/etudes/etudes-util/tags/1.0.17/etudes-util/util/src/java/org/etudes/util/HtmlHelper.java $
 * $Id: HtmlHelper.java 82812 2013-02-25 20:41:15Z ggolden@etudes.org $
 ***********************************************************************************
 *
...
public class HtmlHelper
{
	...
	protected static String cleanWithJtidy(String source, boolean fragment)
	{
		...
		try
		{
			...
			tidy.setFixBackslash(false); // Added By Thabo Mogaswa to stop the conversion of black slashes to front slashes.
