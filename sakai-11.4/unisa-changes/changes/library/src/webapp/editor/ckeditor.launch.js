...
sakai.editor.editors.ckeditor.launch = function(targetId, config, w, h) {
	...
	//Some defaults for audio recorder
        ...
        // Unisa Changes:2018/12/10: Changed Basic Toolbar to add more functions to mobile editor
        /*toolbar_Basic:
        [
        ...
        toolbar_Basic:
        [
            ['Source', '-', 'Bold', 'Italic', 'Underline', '-', 'Link', '-', 'NumberedList','BulletedList'],
            '/',
            ['Styles', 'Font', 'FontSize', 'TextColor', '-', 'Image', 'Movie']
        ],        
        // End Unisa Changes:2018/12/10
        toolbar_Full:
        [
            ['Source','-','Templates'],
            ...
            ['BidiLtr', 'BidiRtl' ],
            ['Link','Unlink','Anchor'],
            // Unisa Changes:2018/12/10: Added CodeCogs Equation Editor
            ...
            (sakai.editor.enableResourceSearch
                    ? ['AudioRecorder','ResourceSearch', 'Image','Movie','Table','HorizontalRule','Smiley','SpecialChar','Equation','fmath_formula','FontAwesome']
                    : ['AudioRecorder','Image','Movie','Table','HorizontalRule','Smiley','SpecialChar','Equation','fmath_formula','FontAwesome']),
             // End Unisa Changes:2018/12/10
            '/',
    ...
    (function() {
        ...
        if (getWidth() < 800) {
            ...
            // Unisa Changes:2018/12/10: Added 'Edit Movie' and 'Insert Image' plugins to mobile/basic toolbar
            CKEDITOR.plugins.addExternal('lineutils',basePath+'lineutils/', 'plugin.js');		// required by widget plugin
            CKEDITOR.plugins.addExternal('widget',basePath+'widget/', 'plugin.js');				// reqiured by image2 plugin
            CKEDITOR.plugins.addExternal('iframedialog',basePath+'iframedialog/', 'plugin.js');	// SAK-22505
            ...
            ckconfig.extraPlugins+="image2,movieplayer";
            // End Unisa Changes:2018/12/10
        }
        else {
            ...
            CKEDITOR.plugins.addExternal('equation',basePath+'equation/', 'plugin.js'); // Unisa Changes:2018/12/10: Added CodeCogs Equation Editor
            ...
            ckconfig.extraPlugins+="image2,audiorecorder,movieplayer,wordcount,equation,fmath_formula,autosave,fontawesome,notification";
            // End Unisa Changes:2018/12/10: 
