...
public class ItemModifyListener implements ActionListener
{
  ...
  public boolean populateItemBean(ItemAuthorBean itemauthorbean, String itemId) {
    ...
    try {
      ...
      //if (itemfacade.getSequence() != null) { //Commented by mphahsm on 05/2017
      
      // mphahsm added unisa-changes: To apply the patch SAM-2591 and fix the error to edit questions in question pool 
      ...
      //End of unisa-changes Add
        ...
        if (!authzBean.isUserAllowedToEditAssessment(assessmentId.toString(), createdBy, !isEditPendingAssessmentFlow)) {
          ...
          //mphahsm added unisa-change: To apply the patch SAM-2591 and fix the error to edit questions in question pool
