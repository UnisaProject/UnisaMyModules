...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
  <head>
    ...
    <!-- Unisa Changes:2018/10/16:Change location of eport.css file, included within current webapp -->
    <!-- <link rel="stylesheet" type="text/css" media="all" href="/osp-common-tool/css/eport.css" /> -->
    <link rel="stylesheet" type="text/css" media="all" href="/osp-glossary-tool/css/eport.css" />
    ...
    <script type="text/javascript" language="JavaScript" src="/osp-glossary-tool/js/eport.js"></script>
    <!-- End Unisa Changes:2018/10/16 -->
  <%
