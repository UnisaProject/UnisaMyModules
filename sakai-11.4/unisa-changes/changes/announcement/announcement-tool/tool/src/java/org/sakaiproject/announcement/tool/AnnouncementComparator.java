...
class AnnouncementComparator implements Comparator<AnnouncementAction.AnnouncementWrapper> {
    ...
    private AnnouncementMessage announcementMesssage; //Unisa-Changes: Added by mphahsm: 2018/04 to apply fix to SAK-30064
    ...
    public int compare(AnnouncementAction.AnnouncementWrapper o1, AnnouncementAction.AnnouncementWrapper o2) {
        ...
        if (m_criteria.equals(AnnouncementAction.SORT_SUBJECT)) {
            ...
            if (o1ModDate != null && o2ModDate != null) {
				...
				/* Unisa-Changes: Commented out by mphahsm: 2018/04
                if (o1ModDate.before(o2ModDate)) {
                    result = -1;
                } else {
                    result = 1;
                } End of mphahsm comments*/
				result = o1ModDate.compareTo(o2ModDate); //Unisa-Changes: Added by mphahsm: 2018/04 to apply fix to SAK-30064
            } else if (o1ModDate == null) {
                return 1;
            }
			//else //Unisa-Changes: Commented out by mphahsm: 2018/04
			else if (o2ModDate == null) //Unisa-Changes: Added by mphahsm: 2016/08 to apply fix to SAK-30064
			{
                return -1;
            }
			else //Unisa-Changes: Added by mphahsm: 2018/04 to apply fix to SAK-30064
			{
					return 0;
			} //End of mphahsm add
        } else if (m_criteria.equals(AnnouncementAction.SORT_MESSAGE_ORDER)) {
            
			int order1 = ((AnnouncementMessage) o1).getAnnouncementHeader().getMessage_order(); //Unisa-Changes: Added by mphahsm: 2018/04 to apply fix to SAK-30064
			int order2 = ((AnnouncementMessage) o2).getAnnouncementHeader().getMessage_order(); //Unisa-Changes: Added by mphahsm: 2018/04 to apply fix to SAK-30064
			// sorted by the message order
			/* Unisa-Changes: Commented out by mphahsm: 2018/04
            if ((((AnnouncementMessage) o1).getAnnouncementHeader().getMessage_order()) <
                    (((AnnouncementMessage) o2).getAnnouncementHeader().getMessage_order()))*/ //End of mphahsm comment
			if (order1 < order2) //Unisa-Changes: Added by mphahsm: 2018/04 to apply fix to SAK-30064
			{
                result = -1;
            } 
			//else //Unisa-Changes: Commneted out by mphahsm: 2018/04
			else if (order1 > order2) //Added by mphahsm: 2018/04 to apply fix to SAK-30064
			{
                result = 1;
            }
			else //Added by mphahsm: 2018/04 to apply fix to SAK-30064
			{
				return 0;
			} // End of mphahsm add
            ...
            if (o1releaseDate != null && o2releaseDate != null) {
				...
				result = o1releaseDate.compareTo(o2releaseDate); //Unisa-Changes: Added by mphahsm: 2018/04 to apply fix to SAK-30064
            } else if (o1releaseDate == null) {
                return 1;
            }
			//else //Unisa-Changes: Commented out by mphahsm: 2018/04
			else if (o2releaseDate == null) //Unisa-Changes: Added by mphahsm: 2018/04 to apply fix to SAK-30064
			{
                return -1;
            }
			else //Unisa-Changes: Added by mphahsm: 2018/04 to apply fix to SAK-30064
            ...
            if (o1retractDate != null && o2retractDate != null) {
                ...
                if (o1retractDate.before(o2retractDate)) {
                    ...
                    result = 1;
                }*/ //End of mphahsm Comment
				result = o1retractDate.compareTo(o2retractDate); //Unisa-Changes: Added by mphahsm: 2018/04 to apply fix to SAK-30064
            } else if (o1retractDate == null) {
                return 1;
            }
			//else //Unisa-Changes: Commented out by mphahsm: 2018/04
			else if (o2retractDate == null) //Unisa-Changes: Added by mphahsm: 2018/04 to apply fix to SAK-30064
			{
                return -1;
            }
			else //Unisa-Changes: Added by mphahsm: 2018/04 to apply fix to SAK-30064
    ...
    //Unisa-Changes: Added by mphahsm: 2018/04 to apply fix to SAK-30064
    /*
	 * (non-Javadoc)
	 * 
