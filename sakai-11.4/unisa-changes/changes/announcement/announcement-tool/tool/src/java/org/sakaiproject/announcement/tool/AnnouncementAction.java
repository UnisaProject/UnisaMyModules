 /**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/announcement/tags/sakai-10.5/announcement-tool/tool/src/java/org/sakaiproject/announcement/tool/AnnouncementAction.java $
		...
		public int compare(Object o1, Object o2)
		{
			...
			else if (m_criteria.equals(SORT_DATE))
			{
				...
				if (o1ModDate != null && o2ModDate != null) 
				{
					...
					/* Unisa-Changes: Commented out by mphahsm: 2016/08
					...
					result = o1ModDate.compareTo(o2ModDate); //Unisa-Changes: Added by mphahsm: 2016/08 to apply fix to SAK-30064
				}
				else if (o1ModDate == null)
				{
					return 1;
				}
				//else //Unisa-Changes: Commented out by mphahsm: 2016/08
				else if (o2ModDate == null) //Unisa-Changes: Added by mphahsm: 2016/08 to apply fix to SAK-30064
				{
					return -1;
				}
				else //Unisa-Changes: Added by mphahsm: 2016/08 to apply fix to SAK-30064
				{
					return 0;
				} //End of mphahsm add
			}
			...
			{
				int order1 = ((AnnouncementMessage) o1).getAnnouncementHeader().getMessage_order(); //Unisa-Changes: Added by mphahsm: 2016/08 to apply fix to SAK-30064
				int order2 = ((AnnouncementMessage) o2).getAnnouncementHeader().getMessage_order(); //Unisa-Changes: Added by mphahsm: 2016/08 to apply fix to SAK-30064
				// sorted by the message order
				/* Unisa-Changes: Commented out by mphahsm: 2016/08
				if ((((AnnouncementMessage) o1).getAnnouncementHeader().getMessage_order()) <
						(((AnnouncementMessage) o2).getAnnouncementHeader().getMessage_order()))*/ //End of mphahsm Add
				if (order1 < order2) //Unisa-Changes: Added by mphahsm: 2016/08 to apply fix to SAK-30064
				{
					result = -1;
				}
				//else //Unisa-Changes: Commneted out by mphahsm: 2016/08
				else if (order1 > order2) //Added by mphahsm: 2016/08 to apply fix to SAK-30064
				{
					result = 1;
				}
				else //Added by mphahsm: 2016/08 to apply fix to SAK-30064
				{
					return 0;
				} // End of mphahsm add
			}
			else if (m_criteria.equals(SORT_RELEASEDATE))
			{
				...
				if (o1releaseDate != null && o2releaseDate != null) 
				{
					...
					result = o1releaseDate.compareTo(o2releaseDate); //Unisa-Changes: Added by mphahsm: 2016/08 to apply fix to SAK-30064
				}
				...
				//else //Unisa-Changes: Commented out by mphahsm: 2016/08
				else if (o2releaseDate == null) //Unisa-Changes: Added by mphahsm: 2016/08 to apply fix to SAK-30064
				{
					return -1;
				}
				else //Unisa-Changes: Added by mphahsm: 2016/08 to apply fix to SAK-30064
			...
			else if (m_criteria.equals(SORT_RETRACTDATE))
			{
				...
				if (o1retractDate != null && o2retractDate != null) 
				{
					...
					result = o1retractDate.compareTo(o2retractDate); //Unisa-Changes: Added by mphahsm: 2016/08 to apply fix to SAK-30064
				}
				...
				//else //Unisa-Changes: Commented out by mphahsm: 2016/08
				else if (o2retractDate == null) //Unisa-Changes: Added by mphahsm: 2016/08 to apply fix to SAK-30064
				{
					return -1;
				}
				else //Unisa-Changes: Added by mphahsm: 2016/08 to apply fix to SAK-30064
