/**
 * $URL: https://source.sakaiproject.org/svn/sitestats/tags/sakai-10.4/sitestats-impl/src/java/org/sakaiproject/sitestats/impl/StatsManagerImpl.java $
...
public class StatsManagerImpl extends HibernateDaoSupport implements StatsManager, Observer {
	...
	public String getUserNameForDisplay(String userId) {
        ...
        //Unisa change
		//get the name for eid(written to avoid inexistant user in the display)
		 try {
			String tmpUserId = M_uds.getUserId(userId);
		//	System.out.println("tmpUserId "+tmpUserId);
			User user = M_uds.getUser(tmpUserId);
			name = getUserNameForDisplay(user);
