...
public class BBBTool extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        try {
            ...
            // Unisa Changes: 2018/08/01: Force Velocity to log to Tomcat's standard log to prevent 'java.io.FileNotFoundException: velocity.log (Permission denied)'
            // Unisa Changes: 2018/08/01: https://stackoverflow.com/questions/849710/error-in-velocity-and-log4j
            props.setProperty("runtime.log.logsystem.class","org.apache.velocity.runtime.log.Log4JLogChute");
            props.setProperty("runtime.log.logsystem.log4j.logger", "logger");
            // End Unisa Changes: 2018/08/01
