/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/portal/tags/sakai-10.5/portal-impl/impl/src/java/org/sakaiproject/portal/charon/site/MoreSiteViewImpl.java $
	...
	protected void processMySites()
	{
		...
		if (useDHTMLMore)
		{
			...
			for (int i = 0; i < allSites.size(); i++)
			{
				...
				String term = null;
				//unisa change
				if (("course".equals(type))|| ("onlcourse".equals(type)) || "onlgroup".equals(type) || "group".equals(type))
				{
				...
				//unisa change
				else if ("admin".equals(type)||"Administrative".equals(type))
				{
