...
sakai.editor.editors.ckeditor.launch = function(targetId, config, w, h) {
	...
	//Some defaults for audio recorder
        ...
        [
            ...
            (sakai.editor.enableResourceSearch
                ? ['AudioRecorder','ResourceSearch', 'Image','Movie','Flash','Table','HorizontalRule','Smiley','SpecialChar','Equation','fmath_formula']
                : ['AudioRecorder','Image','Movie','Flash','Table','HorizontalRule','Smiley','SpecialChar','Equation','fmath_formula']),
            '/',
    ...
    if (config) {
		...
		(function() { 
		   ...
		   CKEDITOR.plugins.addExternal('equation',basePath+'equation/','plugin.js');
		   CKEDITOR.plugins.addExternal('audiorecorder',basePath+'audiorecorder/', 'plugin.js'); 
			 ...
			 */
			 ...
			 ckconfig.extraPlugins+="audiorecorder,movieplayer,wordcount,equation,fmath_formula";
    })();
