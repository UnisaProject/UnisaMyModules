...
//			currentEdit=CKEDITOR.currentInstance;
			...
			{
				var url='https://codecogs.unisa.ac.za/eqneditor/editor_json.php?type=url&editor=CKEditor';
				//var url='/eqneditor/editor_json.php?type=url&editor=CKEditor';
	  ...
	  lang : ['en'],
		...
		init : function( editor )
		{
			...
			editor.ui.addButton( 'Equation',
				...
				label : 'CodeCogs Equation Editor',
					command : com,
