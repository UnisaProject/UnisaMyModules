...
public class FaqsService {
	...
	public static List getFaqContentWithCategory(int contentId) {
		org.sakaiproject.faqs.api.FaqsService service = getInstance();
		if (service == null)
			return null;

		return service.getFaqContentWithCategory(contentId);
	}
	...
	public static void deleteFaqContent(Integer contentId){
		org.sakaiproject.faqs.api.FaqsService service = getInstance();
		service.deleteFaqContent(contentId);
	}

	public static void deleteFaqCategory(Integer categoryId){
		org.sakaiproject.faqs.api.FaqsService service = getInstance();
		service.deleteFaqCategory(categoryId);
	}
